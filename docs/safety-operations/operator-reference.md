...
| `calculateBundledLiquidationTransfer(targetOwnership, targetAllowance, requestedDebt, currentTotalRep, currentDenominator)` | Returns zero when ownership or allowance is zero; caps debt at allowance; promotes debt or REP dust to a full close; partial ownership and REP conversions floor, while a full close moves the exact remaining ownership. | [Proportional bundled liquidation](../protocol-design/liquidation.html#punitive-liquidation) |
