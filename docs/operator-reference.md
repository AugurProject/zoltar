...
| Initial report size | The configured `exactToken1Report` is sized from dispute economics: target error, OpenOracle fees, dispute gas, assumed gas price, REP/ETH price, dispute multiplier, and expected price movement during settlement. It does not scale with the outside funds protected by the price. Current deployment helpers compute `259.332023575638507216 REP` from those inputs. | [SecurityPoolOracleCoordinator.sol](../solidity/contracts/peripherals/SecurityPoolOracleCoordinator.sol), [deploymentHelpers.ts](../ui/ts/contracts/deploymentHelpers.ts), [deployPeripherals.ts](../solidity/ts/testsuite/simulator/utils/contracts/deployPeripherals.ts) |
