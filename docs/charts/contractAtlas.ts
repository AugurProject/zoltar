...
type ContractAtlasSourceDerivedRelation = Extract<ContractAtlasRelation, 'delegatecall' | 'deploys' | 'implements' | 'inherits'>

const sourceDerivedRelationVerbs: Record<ContractAtlasSourceDerivedRelation, string> = {
...
function sourceDerivedEdge(id: string, source: string, target: string, relation: ContractAtlasSourceDerivedRelation): ContractAtlasEdge {
	const targetNode = contractAtlasNodes.find(atlasNode => atlasNode.id === target)
	if (targetNode === undefined) throw new Error(`Source-derived contract atlas edge ${id} has missing target ${target}`)
	const description = `${sourceDerivedRelationVerbs[relation]} ${targetNode.label}.`
	return edge(id, source, target, relation, description)
}
...
const contractAtlasSemanticEdges: ContractAtlasEdge[] = [
	...
	sourceDerivedEdge('zoltar-core-reputation-token', 'zoltar-core', 'zoltar-reputation-token', 'deploys'),
	sourceDerivedEdge('zoltar-reputation-erc20', 'zoltar-reputation-token', 'zoltar-erc20', 'inherits'),
	sourceDerivedEdge('zoltar-erc20-context', 'zoltar-erc20', 'zoltar-context', 'inherits'),
	sourceDerivedEdge('zoltar-erc20-interface', 'zoltar-erc20', 'zoltar-ierc20', 'implements'),
	sourceDerivedEdge('zoltar-erc20-metadata', 'zoltar-erc20', 'zoltar-ierc20-metadata', 'implements'),
	sourceDerivedEdge('zoltar-metadata-erc20', 'zoltar-ierc20-metadata', 'zoltar-ierc20', 'inherits'),
	...
	sourceDerivedEdge('factory-interface', 'statoblast-security-pool-factory', 'statoblast-security-pool-factory-interface', 'implements'),
	...
	sourceDerivedEdge('share-factory-share', 'statoblast-share-token-factory', 'statoblast-share-token', 'deploys'),
	...
	sourceDerivedEdge('price-factory-coordinator', 'statoblast-price-coordinator-factory', 'statoblast-price-coordinator', 'deploys'),
	...
	sourceDerivedEdge('auction-factory-auction', 'statoblast-auction-factory', 'statoblast-truth-auction', 'deploys'),
	sourceDerivedEdge('factory-pool-deployer', 'statoblast-security-pool-factory', 'statoblast-security-pool-deployer', 'deploys'),
	...
	sourceDerivedEdge('pool-deployer-emitter', 'statoblast-security-pool-deployer', 'statoblast-event-emitter', 'deploys'),
	sourceDerivedEdge('pool-deployer-worker', 'statoblast-security-pool-deployer', 'statoblast-security-pool-worker', 'deploys'),
	...
	sourceDerivedEdge('worker-security-pool', 'statoblast-security-pool-worker', 'statoblast-security-pool', 'deploys'),
	sourceDerivedEdge('escalation-factory-verifier', 'statoblast-escalation-game-factory', 'statoblast-escalation-proof-verifier', 'deploys'),
	sourceDerivedEdge('escalation-factory-game', 'statoblast-escalation-game-factory', 'statoblast-escalation-game', 'deploys'),
	...
	sourceDerivedEdge('pool-interface', 'statoblast-security-pool', 'statoblast-security-pool-interface', 'implements'),
	...
	edge('pool-price-coordinator', 'statoblast-security-pool', 'statoblast-price-coordinator', 'calls', 'Reads cached REP/ETH prices.'),
	edge('price-coordinator-pool', 'statoblast-price-coordinator', 'statoblast-security-pool', 'calls', 'Executes staged liquidation, withdrawal, and allowance operations through coordinator-only pool entrypoints after validation.'),
	...
	edge('openoracle-price-callback', 'openoracle-core', 'statoblast-price-coordinator', 'calls', 'Calls openOracleCallback on the configured coordinator after report settlement.'),
	...
	sourceDerivedEdge('share-token-erc1155', 'statoblast-share-token', 'statoblast-erc1155', 'inherits'),
	sourceDerivedEdge('share-token-interface', 'statoblast-share-token', 'statoblast-share-token-interface', 'implements'),
	...
	sourceDerivedEdge('erc1155-interface', 'statoblast-erc1155', 'statoblast-ierc1155', 'implements'),
	...
	sourceDerivedEdge('ierc1155-erc165', 'statoblast-ierc1155', 'statoblast-ierc165', 'inherits'),
	sourceDerivedEdge('receiver-erc165', 'statoblast-ierc1155-receiver', 'statoblast-ierc165', 'inherits'),
	sourceDerivedEdge('pool-event-emitter', 'statoblast-security-pool', 'statoblast-event-emitter', 'delegatecall'),
	edge('pool-forker-runtime', 'statoblast-security-pool', 'statoblast-pool-forker', 'calls', 'Reads resolved question outcomes from the shared forker.'),
	...
	edge('pool-utils-runtime', 'statoblast-security-pool', 'statoblast-security-pool-utils', 'uses', 'Uses shared fee, precision, and minimum-REP constants.'),
	...
	sourceDerivedEdge('game-settlement-base', 'statoblast-escalation-game', 'statoblast-escalation-settlement', 'inherits'),
	sourceDerivedEdge('settlement-escrow-base', 'statoblast-escalation-settlement', 'statoblast-escalation-escrow', 'inherits'),
	sourceDerivedEdge('escrow-carry-base', 'statoblast-escalation-escrow', 'statoblast-escalation-carry', 'inherits'),
	sourceDerivedEdge('carry-calculation-base', 'statoblast-escalation-carry', 'statoblast-escalation-calculations', 'inherits'),
	sourceDerivedEdge('calculation-state-base', 'statoblast-escalation-calculations', 'statoblast-escalation-state', 'inherits'),
	sourceDerivedEdge('state-storage-base', 'statoblast-escalation-state', 'statoblast-escalation-storage', 'inherits'),
	sourceDerivedEdge('state-events-interface', 'statoblast-escalation-state', 'statoblast-escalation-events', 'implements'),
	sourceDerivedEdge('game-deposit-delegate-deploy', 'statoblast-escalation-game', 'statoblast-escalation-deposit-delegate', 'deploys'),
	sourceDerivedEdge('game-deposit-delegate-call', 'statoblast-escalation-game', 'statoblast-escalation-deposit-delegate', 'delegatecall'),
	sourceDerivedEdge('deposit-delegate-storage', 'statoblast-escalation-deposit-delegate', 'statoblast-escalation-storage', 'inherits'),
	sourceDerivedEdge('deposit-delegate-events', 'statoblast-escalation-deposit-delegate', 'statoblast-escalation-events', 'implements'),
	...
	edge('escalation-binary-calculations', 'statoblast-escalation-calculations', 'statoblast-binary-outcomes', 'uses', 'Types question-resolution results and unresolved sentinels with the shared binary-outcome enum.'),
	...
	sourceDerivedEdge('vault-delegate-base', 'statoblast-vault-migration-delegate', 'statoblast-vault-migration-base', 'inherits'),
	sourceDerivedEdge('escalation-forker-base', 'statoblast-escalation-game-forker', 'statoblast-vault-migration-base', 'inherits'),
	sourceDerivedEdge('event-emitter-storage', 'statoblast-event-emitter', 'statoblast-forker-storage', 'inherits'),
	sourceDerivedEdge('event-emitter-events', 'statoblast-event-emitter', 'statoblast-forker-events', 'implements'),
	sourceDerivedEdge('forker-interface-events', 'statoblast-forker-interface', 'statoblast-forker-events', 'inherits'),
	...
	sourceDerivedEdge('forker-delegate-vault', 'statoblast-pool-forker', 'statoblast-vault-migration-delegate', 'delegatecall'),
	sourceDerivedEdge('forker-delegate-escalation', 'statoblast-pool-forker', 'statoblast-escalation-game-forker', 'delegatecall'),
	sourceDerivedEdge('forker-delegate-events', 'statoblast-pool-forker', 'statoblast-event-emitter', 'delegatecall'),
	sourceDerivedEdge('forker-deploy-proxy', 'statoblast-pool-forker', 'statoblast-migration-proxy', 'deploys'),
	...
	edge('forker-pool', 'statoblast-pool-forker', 'statoblast-security-pool', 'calls', 'Freezes parents, migrates children, and updates collateral and ownership accounting through forker-only pool entrypoints.'),
	...
	edge('vault-base-types', 'statoblast-vault-migration-base', 'statoblast-forker-types', 'uses', 'Stores and mutates typed fork and child-REP allocation records.'),
	...
	edge('forker-utils', 'statoblast-pool-forker', 'statoblast-security-pool-utils', 'uses', 'Uses shared auction timing and fixed-point precision.'),
	...
	sourceDerivedEdge('ierc1363-erc20', 'openoracle-ierc1363', 'openoracle-ierc20', 'inherits'),
	sourceDerivedEdge('ierc1363-erc165', 'openoracle-ierc1363', 'openoracle-ierc165', 'inherits'),
	...
	sourceDerivedEdge('test-complete-set-receiver-interface', 'test-complete-set-reentrant-receiver', 'statoblast-ierc1155-receiver', 'implements'),
	sourceDerivedEdge('test-erc1155-coverage', 'test-erc1155-coverage-harness', 'statoblast-erc1155', 'inherits'),
	sourceDerivedEdge('test-coverage-deployment-status-oracle', 'test-coverage-helpers-harness', 'infra-deployment-status-oracle', 'deploys'),
	...
	sourceDerivedEdge('test-coverage-helpers', 'test-coverage-helpers-harness', 'statoblast-escalation-proof-verifier', 'deploys'),
	sourceDerivedEdge('test-receiver-mock', 'test-erc1155-receiver-mock', 'statoblast-ierc1155-receiver', 'implements'),
	...
	edge('test-threshold-pool', 'test-fork-boundary-pool', 'statoblast-escalation-calculations', 'tests', 'Supplies controlled pool state to fork-threshold calculation tests.'),
	sourceDerivedEdge('test-threshold-harness-edge', 'test-fork-threshold-harness', 'statoblast-escalation-calculations', 'inherits'),
	...
	sourceDerivedEdge('test-false-erc20-edge', 'test-false-returning-erc20', 'zoltar-ierc20', 'implements'),
	edge('test-incompatible-verifier-edge', 'test-incompatible-proof-verifier', 'statoblast-escalation-state', 'tests', 'Exercises the game-state constructor proof-verifier code-hash rejection.'),
	sourceDerivedEdge('test-openoracle-token-edge', 'test-openoracle-token', 'zoltar-ierc20', 'implements'),
	...
	sourceDerivedEdge('test-openoracle-receiver-interface', 'test-openoracle-rejecting-receiver', 'statoblast-ierc1155-receiver', 'implements'),
	...
	edge('test-ancestor-edge', 'test-security-pool-ancestor', 'statoblast-pool-forker', 'tests', 'Builds controlled pool ancestry graphs for direct-claim replay checks.'),
	...
	sourceDerivedEdge('test-child-validation-edge', 'test-forker-child-validation-harness', 'statoblast-forker-base', 'inherits'),
