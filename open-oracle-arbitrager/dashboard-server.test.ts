...
test('serves dashboard state and protects mutable controls with same-origin JSON requests', async () => {
	...
	for (const asset of ['/README.md', '/docs/open-oracle-integration.html', '/documentation.css', '/docs/shared-docs.css', '/docs/chartRuntime.js', '/documentation-assets/dashboard-overview.png', '/documentation-assets/dashboard-markets.png']) {
