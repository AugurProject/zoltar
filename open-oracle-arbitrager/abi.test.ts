...
import { peripherals_openOracle_OpenOracle_OpenOracle, peripherals_OpenOracleArbitrageExecutor_OpenOracleArbitrageExecutor, peripherals_OpenOraclePriceCoordinator_OpenOraclePriceCoordinator } from '../solidity/ts/types/contractArtifact'
import { openOracleAbi, openOracleArbitrageExecutorAbi, openOraclePriceCoordinatorAbi } from './abi.js'
