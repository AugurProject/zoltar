...
const positionDerivedSnapshot = operatorSnapshot(
	...
	{ minimumBundleSimulations: 1, mode: 'private', relayUrls: ['https://relay.flashbots.net/'] },
...
const snapshot = {
	...
	submission: { minimumBundleSimulations: 1, mode: 'private' as const, relayUrls: ['https://relay.flashbots.net/'] },
