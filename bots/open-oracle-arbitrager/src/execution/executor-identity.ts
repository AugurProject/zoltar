...
import { getCreate2Address, keccak256 } from '@zoltar/bot-shared/ethereum'
...
export function canonicalExecutorIdentity() {
	return {
		address: getCreate2Address({ from: deterministicDeploymentProxy, salt: canonicalExecutorSalt, bytecode: `0x${executorArtifact.evm.bytecode.object}` }),
		runtimeCodeHash: keccak256(`0x${executorArtifact.evm.deployedBytecode.object}`),
	}
}
