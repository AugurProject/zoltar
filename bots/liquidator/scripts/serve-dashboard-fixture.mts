...
function pool(address: string, questionId: string, selected: boolean, isPriceValid: boolean, candidateCount: number) {
	return {
...
const server = startDashboardServer(4183, {
	...
	getState: () => ({
		...
		paused,
		pools: [pool('0x1111111111111111111111111111111111111111', '42', true, true, 3), pool('0x2222222222222222222222222222222222222222', '108', false, true, 0), pool('0x3333333333333333333333333333333333333333', '900719925474099312345', true, false, 1)],
		scanning: false,
