...
export const securityPoolAbi = [
	...
	{
		inputs: [{ name: 'repAmountAttoRep', type: 'uint256' }],
...
export const securityPoolForkerAbi = [
	{
		...
		name: 'forkData',
		outputs: [
			{ name: 'auctionableRepAtForkAttoRep', type: 'uint256' },
			{ name: 'truthAuction', type: 'address' },
			{ name: 'truthAuctionStarted', type: 'uint256' },
			{ name: 'migratedRepAttoRep', type: 'uint256' },
...
export const coordinatorAbi = [
	...
	},
	{
		...
		inputs: [
			...
			{ indexed: false, name: 'snapshotPoolHeldRepBalanceAttoRep', type: 'uint256' },
			{ indexed: false, name: 'snapshotPoolHeldRepBalanceBackingUnits', type: 'uint256' },
