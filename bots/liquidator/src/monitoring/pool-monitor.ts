...
import { createPoolMonitorIndex, currentVaultPositionForPoolAccounting, loadCurrentVaults, loadVaultPage, resolveOperatorVault, type PoolMonitorIndex, type ReadClient } from '#monitoring/vault-positions'
import type { PoolObservation, StagedOperationObservation } from '#state/operator-state'
import { deploySecurityPoolEvent, erc20Abi, openOraclePriceCoordinatorAbi, securityPoolAbi, securityPoolFactoryAbi, securityPoolForkerAbi } from '@zoltar/bot-shared/contracts/abi'
