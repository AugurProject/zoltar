				...
				pools: [
					{
						...
						selected: true,
						systemState: '0',
						totalObligationUnitsDisplay: '12',
						totalPoolHeldRep: '13',
						universeId: '14',
		...
		expect(Reflect.get(snapshot, 'pools')).toEqual([
			{
				...
				botVault: { obligationUnitsDisplay: '6', claimableFeesEth: '0.1', healthBps: '12500', openInterestDisplay: '2', vaultRepBacking: '7' },
				candidateCount: 1,
				centralizedPriceAllowed: true,
				isPriceValid: true,
				knownVaultCount: '9',
