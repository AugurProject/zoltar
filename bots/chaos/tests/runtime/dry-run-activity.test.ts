...
test('a dry-run activity records the exact planned work and publishes it to the dashboard', () => {
	...
	expect(details).toContain('1. Approve REP spending (to 0x1111111111111111111111111111111111111111, selector 0x095ea7b3, gas 120000)')
	expect(details).toContain('2. Create the question (to 0x2222222222222222222222222222222222222222, selector 0xabcdef01, gas 450000, value 1500 attoETH)')
