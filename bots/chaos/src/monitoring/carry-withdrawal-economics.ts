export function computeWinningEconomics(parameters: { principalAttoRep: bigint; actualForkThresholdAttoRep: bigint; bindingCapitalAttoRep: bigint; cumulativeAmountAttoRep: bigint; depositAmountAttoRep: bigint; nonDecisionThresholdAttoRep: bigint; winningOutcomeBalanceAttoRep: bigint }) {
	...
	let amountToWithdrawAttoRep = parameters.principalAttoRep
