...
export const MUTATING_CONTRACT_SURFACE: readonly ContractMethodClassification[] = [
	...
	entry('Zoltar', 'forkUniverseWithPermit', 'excluded-dangerous', undefined, 'Permit signing requires an explicit wallet-intent workflow; chaos retains the approval-based fork path.'),
	entry('Zoltar', 'forkUniverseWithAuthorization', 'excluded-dangerous', undefined, 'Relaying a signed fork authorization requires durable signed-intent provenance outside randomized execution.'),
	entry('Zoltar', 'burnRep', 'selectable', 'zoltar.rep.burn'),
	entry('Zoltar', 'burnRepWithPermit', 'excluded-dangerous', undefined, 'Permit signing requires an explicit wallet-intent workflow; chaos retains the approval-based burn path.'),
	entry('Zoltar', 'burnRepWithAuthorization', 'excluded-dangerous', undefined, 'Relaying a signed burn authorization requires durable signed-intent provenance outside randomized execution.'),
	...
	entry('Zoltar', 'addRepToMigrationBalanceWithPermit', 'excluded-dangerous', undefined, 'Permit signing requires an explicit wallet-intent workflow; chaos retains the approval-based migration path.'),
	entry('Zoltar', 'addRepToMigrationBalanceWithAuthorization', 'excluded-dangerous', undefined, 'Relaying a signed REP migration authorization requires durable signed-intent provenance outside randomized execution.'),
	...
	entry('GenesisReputationToken', 'permit', 'excluded-dangerous', undefined, 'Permit signing requires an explicit wallet-intent workflow; chaos retains exact approval steps.'),
	entry('GenesisReputationToken', 'transferWithAuthorization', 'excluded-dangerous', undefined, 'Raw signed transfers have no ecosystem postcondition and can strand genesis REP.'),
	entry('GenesisReputationToken', 'receiveWithAuthorization', 'excluded-dangerous', undefined, 'Relayed raw transfers have no ecosystem postcondition and can strand genesis REP.'),
	entry('GenesisReputationToken', 'cancelAuthorization', 'excluded-dangerous', undefined, 'Chaos does not originate durable signed token authorizations whose nonce it can safely cancel.'),
