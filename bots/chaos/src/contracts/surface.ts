...
export const MUTATING_CONTRACT_SURFACE: readonly ContractMethodClassification[] = [
	...
	entry('SecurityPool', 'createCompleteSet', 'selectable', 'statoblast.complete-set.create', undefined, ['createCompleteSet()', 'createCompleteSet((address,uint256)[])']),
	...
	entry('SecurityPool', 'configureCoverageVault', 'role-restricted', undefined, 'Only SecurityPoolForker migrates assigned obligation units.'),
	entry('SecurityPool', 'setCoverageFinancials', 'role-restricted', undefined, 'Only SecurityPoolForker initializes obligation buckets.'),
	entry('SecurityPool', 'setCoverageOffer', 'excluded-dangerous', undefined, 'Underwriting authorization requires an explicit vault-owner decision.'),
	...
	entry('SecurityPool', 'creditFinalizedAuctionCoverage', 'role-restricted', undefined, 'Only SecurityPoolForker assigns auction fees.'),
	...
	entry('SecurityPoolOperationsDelegate', 'configureCoverageVault', 'excluded-dangerous', undefined, 'This storage-coupled entrypoint is valid only through the authorized SecurityPool host.'),
	entry('SecurityPoolOperationsDelegate', 'setCoverageFinancials', 'excluded-dangerous', undefined, 'This storage-coupled entrypoint is valid only through the authorized SecurityPool host.'),
	entry('SecurityPoolOperationsDelegate', 'creditFinalizedAuctionCoverage', 'excluded-dangerous', undefined, 'This storage-coupled entrypoint is valid only through the authorized SecurityPool host.'),
	entry('SecurityPoolOperationsDelegate', 'withdrawRepFromVault', 'excluded-dangerous', undefined, 'Withdrawals execute only through the authorized SecurityPool host.'),
	entry('SecurityPoolOperationsDelegate', 'redeemRepFromVault', 'excluded-dangerous', undefined, 'This storage-coupled entrypoint is valid only through the authorized SecurityPool host.'),
	...
	entry('SecurityPoolOperationsDelegate', 'adjustVaultBackingFactor', 'excluded-dangerous', undefined, 'This storage-coupled module is valid only through SecurityPool fallback and requires an explicit vault-owner capacity decision.'),
	...
	entry('SecurityPoolOperationsDelegate', 'setFundedSettlementCollateral', 'excluded-dangerous', undefined, 'This storage-coupled module is valid only through SecurityPool delegatecall during inherited-financial installation.'),
	...
	entry('EscalationGameDepositDelegate', 'consumeCarriedDeposit', 'excluded-dangerous', undefined, 'This per-game storage-coupled module is valid only through internal EscalationGame delegatecall after proof and nullifier validation.'),
