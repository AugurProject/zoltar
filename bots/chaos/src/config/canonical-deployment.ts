...
// Sepolia core deployment from the manifest preceding 917babb8c. Existing
// unpinned operators need its roots but still use the published Uniswap factory.
