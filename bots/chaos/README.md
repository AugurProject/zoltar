...
Request drain from the dashboard or CLI with an exact confirmation containing the active profile and configured signer address. The signer wallet is the only retirement destination:
