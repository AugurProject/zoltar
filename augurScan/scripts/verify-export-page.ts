...
if (headerPath === undefined || bodyPath === undefined || dataset === undefined || chainId === undefined || canonical === undefined || fromBlock === undefined || toBlock === undefined || (previousPath === undefined) !== (requestCursor === undefined) || process.argv.length > 11)
	throw new Error('Usage: bun scripts/verify-export-page.ts <headers> <ndjson-body> <dataset> <chain-id> <canonical> <from-block> <to-block> [previous-validation.json request-cursor]')
