...
export async function storeEntityStateSnapshots(this: ScannerDatabase, chainId: number, blockNumber: bigint, blockHash: Hash, blockTimestamp: Date, snapshots: readonly EntityStateSnapshot[], lease: IndexerLease, provenance?: EvidenceProvenance): Promise<void> {
...
export async function storeRichListBalances(this: ScannerDatabase, chainId: number, blockNumber: bigint, blockHash: Hash, balances: readonly RichListBalance[], lease: IndexerLease, provenance?: EvidenceProvenance): Promise<void> {
