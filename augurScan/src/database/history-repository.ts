...
export async function checkpoint(this: ScannerDatabase, chainId: number, lease?: IndexerLease): Promise<{ readonly number: bigint; readonly hash: Hash } | undefined> {
...
export async function networkStartBlock(this: ScannerDatabase, chainId: number, lease?: IndexerLease): Promise<bigint | undefined> {
	return await withOptionalIndexerLease(this.sql, lease, async sql => {
...
export async function hasStoredBlocks(this: ScannerDatabase, chainId: number, lease?: IndexerLease): Promise<boolean> {
	return await withOptionalIndexerLease(this.sql, lease, async sql => {
...
export async function storedBlockTip(this: ScannerDatabase, chainId: number, lease?: IndexerLease): Promise<bigint | undefined> {
	return await withOptionalIndexerLease(this.sql, lease, async sql => {
...
export async function canonicalHash(this: ScannerDatabase, chainId: number, number: bigint, lease?: IndexerLease): Promise<Hash | undefined> {
	return await withOptionalIndexerLease(this.sql, lease, async sql => {
...
export async function canonicalCheckpointAtOrBefore(this: ScannerDatabase, chainId: number, number: bigint, lease?: IndexerLease): Promise<{ readonly number: bigint; readonly hash: Hash } | undefined> {
	return await withOptionalIndexerLease(this.sql, lease, async sql => {
...
export async function rewind(this: ScannerDatabase, chainId: number, ancestor: bigint, ancestorHash: Hash | undefined, lease: IndexerLease, reason: Extract<HistoryInvalidationReason, 'chain-reorg' | 'manifest-reset'> = 'chain-reorg', provenance?: EvidenceProvenance): Promise<void> {
