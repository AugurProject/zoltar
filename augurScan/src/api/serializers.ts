...
export const actionJsonColumns = ['arguments', 'display_arguments', 'argument_schema', 'action_arguments', 'action_display_arguments', 'action_argument_schema', 'receipt'] as const
