...
test('renders exact lifecycle amounts, counterparties and outcomes without rounding', () => {
	expect(semanticSummary({ event_data: { badDebtAttoEth: String(1000000000000000001n), outcome: '3', receiver: '0x1111111111111111111111111111111111111111' } })).toContain('1.000000000000000001 ETH')
