	...
	const demoQuestions = [
		{
			...
			start_time: context.pageUrl.searchParams.get('questionTime') === 'out-of-range' ? '8640000000001' : String(Math.floor((Date.now() - 90 * 86_400_000) / 1000)),
			end_time: context.pageUrl.searchParams.get('questionTime') === 'out-of-range' ? '281474976710655' : String(Math.floor((Date.now() + 620 * 86_400_000) / 1000)),
			num_ticks: '0',
			display_value_min: '0',
			display_value_max: '0',
			answer_unit: '',
		...
		},
		{
			...
			start_time: String(Math.floor((Date.now() - 60 * 86_400_000) / 1000)),
			end_time: String(Math.floor((Date.now() + 510 * 86_400_000) / 1000)),
		...
		},
		{
			...
			start_time: String(Math.floor((Date.now() - 35 * 86_400_000) / 1000)),
			end_time: String(Math.floor((Date.now() - 5 * 86_400_000) / 1000)),
			num_ticks: '0',
			display_value_min: '0',
			display_value_max: '0',
			answer_unit: '',
