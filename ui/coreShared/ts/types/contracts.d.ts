...
export type ForkAuctionAction = 'forkWithOwnEscalation' | 'initiateFork' | 'createChildUniverse' | 'migrateRepToZoltar' | 'migrateVault' | 'claimParentEscalationDeposits' | 'migrateUnresolvedEscalation' | 'startTruthAuction' | 'submitBid' | 'refundLosingBids' | 'finalizeTruthAuction' | 'claimAuctionProceeds' | 'settleForkedEscalation' | 'forkUniverse';
...
export type ReportingDetails = (ReportingDetailsBase & {
    status: 'not-started';
