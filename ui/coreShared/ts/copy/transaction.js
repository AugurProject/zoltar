...
export const formatDeployingValue = (contractLabel) => `Deploying ${contractLabel}`;
export const formatValueDeployed = (contractLabel) => `${contractLabel} Deployed`;
...
export const formatQueuedOperationAutoExecutionDetail = (operationId) => `Staged operation #${operationId} was queued for the next oracle settlement.`;
export const formatQueuedOperationManualExecutionDetail = (operationId) => `Staged operation #${operationId} was queued and must be executed manually after a valid oracle price is available.`;
...
export const formatQueuedLiquidationAutoExecutionDetail = (operationId) => `Liquidation staged as operation #${operationId} for the next oracle settlement.`;
export const formatQueuedLiquidationManualExecutionDetail = (operationId) => `Liquidation staged as operation #${operationId} and must be executed manually after a valid oracle price is available.`;
...
export const formatFinalizedRefundSettlementResultDetail = (capacityOwnershipLabel) => `Selected finalized truth-auction refund rows were settled. Locked ETH was returned without assigning REP backing units or ${capacityOwnershipLabel}.`;
export const formatWinningBidSettlementResultDetail = (capacityOwnershipLabel) => `Selected truth-auction winning bids were settled. The selected bids received REP backing units plus ${capacityOwnershipLabel}, assigning the remaining capacity ownership.`;
export const formatMixedBidSettlementResultDetail = (capacityOwnershipLabel) => `Selected truth-auction bids were settled. Winning bids received REP backing units plus ${capacityOwnershipLabel}, assigning the remaining capacity ownership; refund-only rows returned locked ETH.`;
