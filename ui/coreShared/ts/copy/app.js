...
export const formatSwitchToNetwork = (networkName) => `Switch to ${networkName}`;
...
export const formatNetworkWithChainId = (networkLabel, chainId) => `${networkLabel} (${chainId})`;
export const oracleReports = 'Open Oracle';
export const refreshRepPrices = 'Refresh REP prices';
export const formatRepPricingUnavailable = (networkName) => `Not configured on ${networkName}`;
...
export const formatReadRpcOverrideIgnoredDetail = (sourceLabel, url, reason, configuredRpcLabel, activeRpcUrl) => `Ignored ${sourceLabel} RPC override (${url}): ${reason} ${configuredRpcLabel} is ${activeRpcUrl}.`;
export const formatReadRpcOverrideFromUrlDetail = (configuredRpcLabel, rpcUrl) => `${configuredRpcLabel} came from the page URL: ${rpcUrl}. Verify this endpoint before relying on displayed onchain state.`;
export const formatReadRpcOverrideActiveDetail = (configuredRpcLabel, sourceLabel, rpcUrl) => `${configuredRpcLabel} came from ${sourceLabel}: ${rpcUrl}. Verify this endpoint before relying on displayed onchain state.`;
...
export const formatShowEarlierNavigationItems = (navigationLabel) => `Show earlier ${navigationLabel}`;
export const formatShowLaterNavigationItems = (navigationLabel) => `Show later ${navigationLabel}`;
...
export const formatWrongNetworkBadgeLabel = (networkLabel) => `Wrong Network (${networkLabel})`;
