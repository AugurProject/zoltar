...
export const universeForkedWarningTitle = 'Universe forked'
export const universeForkedWarningDetail = 'This universe has forked. Migrate REP into the destination universe before continuing with new actions.'
