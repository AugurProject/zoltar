...
export const universeForkedLead = 'This universe forked'
export const forkedOnConnector = 'on'
export const migrateRepToChildUniverse = 'Migrate your REP to a child universe.'
...
export const accountDetails = 'Account details'
export const network = 'Network'
export const latestBlock = 'Latest block'
export const moreSections = 'More'
