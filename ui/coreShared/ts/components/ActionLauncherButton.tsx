...
export function ActionLauncherButton({ describedBy, showDisabledReason = true, ...props }: ActionLauncherButtonProps) {
	...
	const rendersDisabledReason = showDisabledReason && props.availability?.disabled === true && (props.availability.reason !== undefined || props.availability.walletBlocker !== undefined)
