...
function isDedicatedWorkerGlobalScope(value) {
        ...
        try {
            if (message.type === 'init') {
                ...
                if (dependencies === undefined)
                    throw new Error('Simulation engine dependencies were not registered before worker initialization');
