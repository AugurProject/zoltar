export const formatWrappedValue = (value) => `(${value})`;
...
export const formatValueUnavailable = (label) => `${label} unavailable`;
export const formatCollateralizationWithTarget = (label, value, target) => `${label}: ${value}; target: ${target}`;
export const formatTargetValue = (value) => `Target ${value}`;
export const formatCopyExactCurrencyValue = (exactValue) => `Copy exact value ${exactValue}`;
