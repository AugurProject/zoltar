...
export type SimulationWorkerCallMap = {
    ...
    getAccounts: {
        params: undefined;
        result: readonly Address[];
    };
    getState: {
        params: undefined;
        result: SimulationWorkerState;
    };
...
type SimulationWorkerJsonValue = string | number | boolean | bigint | null | {
    [key: string]: SimulationWorkerJsonValue;
} | SimulationWorkerJsonValue[] | readonly SimulationWorkerJsonValue[];
...
export {};
//# sourceMappingURL=tevmWorkerProtocol.d.ts.map