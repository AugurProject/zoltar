...
const dependencyPaths: Dependency[] = [
	...
	{ packageName: '@noble/hashes', subfolderToVendor: '', mainEntrypointFile: 'index.js', alternateEntrypoints: { crypto: 'crypto.js', sha3: 'sha3.js', utils: 'utils.js', _assert: '_assert.js', sha256: 'sha256.js', sha512: 'sha512.js', pbkdf2: 'pbkdf2.js', hmac: 'hmac.js', ripemd160: 'ripemd160.js' } },
	{ packageName: '@noble/curves', subfolderToVendor: '', mainEntrypointFile: 'index.js', alternateEntrypoints: { secp256k1: 'secp256k1.js', 'abstract/modular': 'abstract/modular.js', 'abstract/utils': 'abstract/utils.js', utils: 'utils.js' } },
