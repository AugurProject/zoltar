...
import { ESCALATION_GAME_ACTIVATION_DELAY, getEscalationPhase, getStrictLeadingEscalationOutcome, isPoolQuestionFinalized } from './reportingDomain.js'
...
export function getReportingStagePresentation({
	...
	const leadingOutcome = getStrictLeadingEscalationOutcome(reportingDetails.sides)
