...
export const vaultBackingFactorHelp = 'REP backing relative to exposure at full capacity. Higher targets provide less capacity.'
...
export const positiveCapacityRequired = 'Backing factor must leave positive capacity.'
