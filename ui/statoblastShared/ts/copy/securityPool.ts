...
export const targetHealthFactor = 'Target backing factor'
export const targetHealthFactorHelp = 'Sets the vault target. Future deposits use this factor. Minimum 1.00×.'
...
export const vaultBackingFactor = 'Vault target backing factor'
export const vaultBackingFactorHelp = 'Saved for this vault and used for future deposits. Higher factors provide less capacity. Minimum 1.00×.'
