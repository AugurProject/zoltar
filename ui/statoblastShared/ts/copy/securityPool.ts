...
export const useQuestionId = 'Use a question ID'
export const createNewQuestion = 'Create a new question'
export const questionCreatedPoolPending = 'Question created. The security pool transaction is next.'
export const retryPoolCreation = 'Retry pool creation'
export const createQuestionAndPool = 'Create question and pool'
export const checkingQuestionExists = 'Checking whether this question exists…'
export const questionAlreadyExists = 'This question already exists.'
export const questionAlreadyHasPool = 'A pool already exists for this question and configuration.'
export const openExistingPool = 'Open existing pool →'
export const useExistingQuestion = 'Use existing question'
export const questionExistenceUnavailable = 'Could not check whether this question exists. Try again after the connection recovers.'
...
export const confirmPriceRequest = 'Request new price'
...
export const requestPriceFundingRisk = 'ETH includes a 20% request buffer. REP and WETH report deposits are calculated in the next review.'
...
export const noPoolSelectedHint = 'Enter a pool address above or browse pools.'
...
export const questionIdFallbackHint = 'Enter an exact binary Yes / No Zoltar question ID.'
...
export const vaultHealthHealthy = 'Healthy'
export const vaultHealthNearMinimum = 'Near minimum'
...
export const adjustVaultBackingFactor = 'Adjust backing ratio'
export const adjustingVaultBackingFactor = 'Adjusting backing ratio'
...
export const positiveCapacityRequired = 'Choose a target that supports a positive amount of exposure.'
export const initialReportPriorityFeeEthLabel = 'Initial Report Priority Fee (ETH)'

export const backingRatioChangeQueued = 'Backing ratio change queued'
export const backingRatioChangeExecuted = 'Backing ratio changed'
export const backingRatioChangeFailed = 'Backing ratio change failed'
export const backingRatioChangeSubmitted = 'Backing ratio change submitted'
export const refreshingBackingRatioStatus = 'Refreshing backing ratio status'
export const refreshingBackingRatioStatusDetail = 'Checking the target change result.'
export const backingRatioChangeSuccessDetail = 'The saved target now applies to this vault and future deposits.'
export const queuedVaultAutomaticExecution = 'Executes automatically when the oracle report settles.'

export const exposureSupported = 'Exposure supported'
...
export const reviewDepositAmount = 'Deposit'
export const reviewWithdrawAmount = 'Withdraw'
export const reviewVaultRepBacking = 'Vault REP backing'
export const reviewDepositRisk = 'Deposited REP backs open interest and can be liquidated if the vault falls below its required backing.'
