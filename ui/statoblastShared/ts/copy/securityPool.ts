...
export const targetHealthFactor = 'Deposit backing factor'
export const targetHealthFactorHelp = 'Controls how much capacity this deposit adds. Higher factors add less capacity for the same REP. Minimum 1.00×.'
...
export const adjustVaultBackingFactor = 'Adjust backing factor'
export const adjustingVaultBackingFactor = 'Adjusting backing factor'
export const vaultBackingFactor = 'Vault backing factor'
export const vaultBackingFactorHelp = 'Applies to all REP currently held in your vault. Higher factors provide less capacity. Minimum 1.00×.'
export const adjustVaultBackingFactorDescription = 'Change vault capacity without depositing or withdrawing REP.'
