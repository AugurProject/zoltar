...
export const formatAddMigrationRepDetail = (attoRepAmount) => `Add ${attoRepAmount} REP to your migration balance from this universe, then split it across the selected universes.`;
...
export const formatForkQuestionActiveReason = (endTime, relativeEndTime) => `The selected question must end before the universe can fork. It ends ${endTime} (${relativeEndTime}).`;
...
export const formatMigrationRepShortfall = (repShortfallAttoRep) => `Need ${repShortfallAttoRep} more REP in this universe to prepare the selected amount.`;
export const migrationApprovalPendingDetail = 'Waiting for approved REP amount before preparing the selected amount.';
export const formatMigrationPreparationRequired = (attoRepAmount) => `Add ${attoRepAmount} REP to your migration balance first, then split it across the selected universes.`;
...
export const formatSplitCapacityDetail = (remainingCapacity) => `The selected universes only have ${remainingCapacity} REP of room left for this amount. Reduce the amount or choose different universes.`;
export const formatMigrationBalanceExceeded = (availableRep, migrationBalance, walletBalance) => `You only have ${availableRep} REP available for migration in this universe (${migrationBalance} in your migration balance and ${walletBalance} wallet REP).`;
...
export const destinationRepAfterSplit = (destination) => `${destination} REP After Split`;
