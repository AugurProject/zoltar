...
export const formatMalformedOutcomeLabel = (outcomeIndex) => `Malformed (${outcomeIndex})`;
...
export const formatActionUnavailableReason = (actionLabel) => `${actionLabel} is not available right now.`;
...
export const formatNoSharesAvailableToMigrateReason = (outcomeLabel) => `No ${outcomeLabel} shares available to migrate.`;
...
export const mintBalanceRisk = 'ETH is locked as settlement collateral until matching complete sets are redeemed or winning shares settle.';
...
export const estimatedRetentionFee = 'Estimated Retention Fee';
