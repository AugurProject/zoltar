...
export const formatOpenPoolLabel = (questionTitle, securityPoolAddress) => `Open pool: ${questionTitle} (${securityPoolAddress})`;
...
export const formatPoolPageSummary = (matchingPoolCount, loadedPoolCount, poolLabel, matchVerb) => `${matchingPoolCount} of ${loadedPoolCount} ${poolLabel} ${matchVerb}.`;
...
export const formatVaultDirectorySummary = (loadedVaultCount, totalVaultCount) => `Showing ${loadedVaultCount} current positions from ${totalVaultCount} known vaults, newest-registered first.`;
...
export const formatNoCurrentVaultPositions = (knownVaultCount) => `No current positions among ${knownVaultCount.toString()} known ${knownVaultCount === 1n ? 'vault' : 'vaults'}.`;
...
export const formatPendingReportLabel = (reportId) => `Report #${reportId}`;
...
export const formatShowingActiveStagedOperationsLabel = (loadedCount, activeCount) => `Showing ${loadedCount} of ${activeCount} active staged operations, newest first.`;
...
export const formatInsufficientRepBalanceDetail = (amount) => `Insufficient REP balance. Deposit amount exceeds your wallet balance by ${amount} REP.`;
...
export const formatManualExecutionTimeoutResolvedDetail = (duration) => `This queued self-service operation will expire ${duration} after the oracle settlement window completes.`;
...
//# sourceMappingURL=securityPool.js.map