...
export const formatApprovingTokenPendingLabel = (tokenSymbol) => `Approving ${tokenSymbol}…`;
export const formatApproveToken = (tokenSymbol) => `Approve ${tokenSymbol}`;
export const formatTokenApproved = (tokenSymbol) => `${tokenSymbol} Approved`;
export const formatTokenWithdrawn = (tokenSymbol) => `${tokenSymbol} Withdrawn`;
export const browseReports = 'Browse Reports';
export const formatBrowseShownCountSummary = (shownCount, pageCount) => `${shownCount} of ${pageCount} reports shown on this page.`;
...
export const formatCurrentAmount1Label = (tokenSymbol) => `Current Amount 1 (${tokenSymbol})`;
export const formatCurrentAmount2Label = (tokenSymbol) => `Current Amount 2 (${tokenSymbol})`;
export const formatTokenPairSuffix = (token1Symbol, token2Symbol) => `${token1Symbol} / ${token2Symbol}`;
export const formatReportBrowseTitle = (token1Symbol, token2Symbol, reportId) => `${token1Symbol} / ${token2Symbol} · Report #${reportId}`;
...
export const formatDisconnectedWalletApprovalReason = (tokenSymbol) => `Connect a wallet before approving ${tokenSymbol}.`;
...
export const formatDisputeAmountsInvalidReason = (tokenSymbol) => `Enter valid dispute amounts before approving ${tokenSymbol}.`;
...
export const formatExactTokenRequiredLabel = (tokenSymbol) => `Exact ${tokenSymbol} Required`;
...
export const formatNewAmountMustBeExactDetail = (tokenSymbol, amount) => `New ${tokenSymbol} amount must be exactly ${amount} for this dispute.`;
...
export const withdrawBalance = (tokenSymbol) => `Withdraw ${tokenSymbol}`;
export const withdrawingBalance = (tokenSymbol) => `Withdrawing ${tokenSymbol}…`;
export const checkingWithdrawalBalance = (tokenSymbol) => `Checking ${tokenSymbol} balance…`;
export const confirmWithdrawal = 'Confirm withdrawal';
export const withdrawalRecipient = 'Recipient';
export const formatWithdrawalRisk = (tokenSymbol) => `Withdraws the full credited ${tokenSymbol} balance to the connected account. Wallet gas is separate.`;
export const formatWithdrawalBalanceChanged = (tokenSymbol) => `Your withdrawable ${tokenSymbol} balance changed. Review the updated amount and confirm again`;
...
export const formatOpenReportLabel = (reportTitle) => `Open report: ${reportTitle}`;
export const oracleAddress = 'Oracle Address';
export const protocolFeeRecipient = 'Protocol Fee Recipient';
export const report = 'Report';
export const formatReportNumberTitle = (reportId) => `Report #${reportId}`;
...
export const formatTimingValue = (timingAmount, unit) => `${timingAmount} ${unit}`;
export const formatExactSeconds = (seconds) => `${seconds} seconds`;
export const timing = 'Timing';
export const token1Address = 'Base Token Address';
export const formatTokenApprovalTitle = (tokenSymbol) => `${tokenSymbol} Approval`;
...
export const formatNewTokenAmountFieldLabel = (tokenSymbol) => `New ${tokenSymbol} Amount`;
