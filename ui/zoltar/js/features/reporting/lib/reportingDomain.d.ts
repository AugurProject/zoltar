...
export declare function getEscalationTimeRemaining(details: ActiveReportingDetails): bigint;
...
export declare function isReportingClosed(details: ActiveReportingDetails): boolean;
...
export declare function getRemainingSelectedOutcomeContributionCapacity(details: ReportingDetails, outcome: ReportingOutcomeKey): bigint;
...
export declare function getLeadingEscalationOutcome(sides: EscalationSide[]): ReportingOutcomeKey | undefined;
...
export declare function getSelectedOutcomeRewardWindowFillTimestamp(details: ActiveReportingDetails, selectedOutcome: ReportingOutcomeKey, acceptedAmountAttoRep: bigint): bigint | undefined;
