...
import type { SettlementSelectedBid, TransactionIntent } from '../../../features/types.js'
...
function createForkAuctionDetails(overrides: Partial<ForkAuctionDetails> = {}): ForkAuctionDetails {
	return {
		...
		questionOutcome: 'yes',
		auctionableRepAtForkAttoRep: 20n,
...
function createTruthAuctionMetrics(overrides: Partial<TruthAuctionMetrics> = {}): TruthAuctionMetrics {
	return {
		...
		ethRaisedAttoEth: 1n * 10n ** 18n,
		finalized: false,
		hitCap: false,
		maxRepBeingSoldAttoRep: 100n * 10n ** 18n,
		minBidSizeAttoEth: 1n * 10n ** 18n,
		repPurchasableAtBidAttoRep: 1n * 10n ** 18n,
		timeRemaining: 50n,
