			...
			const renderedComponent = await renderIntoDocument(
				<SecurityPoolWorkflowSection
					{...createSecurityPoolWorkflowProps({
						...
						securityPoolAddress: selectedPoolAddress,
						securityPools: [createSelectedPool({ forkOutcome: 'yes', marketDetails: createMarketDetails({ endTime: 2n }), migratedRepAttoRep: 1n, securityPoolAddress: selectedPoolAddress, systemState: 'poolForked' })],
						selectedPoolView: 'reporting',
					})}
					showHeader={false}
				/>,
			...
			const renderedComponent = await renderIntoDocument(
				<SecurityPoolWorkflowSection
					{...createSecurityPoolWorkflowProps({
						...
						securityPoolAddress: selectedPoolAddress,
						securityPools: [createSelectedPool({ forkOutcome: 'yes', marketDetails: createMarketDetails({ endTime: 2n }), migratedRepAttoRep: 5n, securityPoolAddress: selectedPoolAddress, systemState: 'operational', truthAuctionStartedAt: 10n })],
						selectedPoolView: 'fork-workflow',
					})}
					showHeader={false}
				/>,
