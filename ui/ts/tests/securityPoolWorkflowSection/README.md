...
```bash
bun test --timeout 300000 ui/ts/tests/securityPoolWorkflowSection/stagedOperations.test.tsx
bun test --timeout 300000 ui/ts/tests/securityPoolWorkflowSection/forkWorkflowState.test.tsx
```
