...
export const ethRaisedAttoEth = 'ETH Raised'
export const repSoldAttoRep = 'REP Sold'
...
export const maxRepBeingSoldAttoRep = 'Max REP Being Sold'
...
export const migratedRepAttoRep = 'Migrated REP'
