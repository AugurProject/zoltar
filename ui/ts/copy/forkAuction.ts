...
export const forkDepositSettlementAvailabilityDetail = 'Fork-carried escalation deposits can be settled after this child pool finalizes.'
export const initiallyDepositedLead = 'Initially deposited: '
export const loadedDepthEth = 'Loaded Depth (ETH)'
...
export const importedDepositSettlementDetail = 'Imported from the parent universe. Settle these positions in this child pool after finalization.'
...
export const truthAuctionLoadRequired = 'Load the truth auction before finalizing.'
...
export const walletEscrowedRepEmpty = 'No escrowed REP remains to migrate for the connected wallet.'
...
export const useUnresolvedMigrationReason = 'Use unresolved escalation migration for this parent pool.'
export const unresolvedMigrationExpiredReason = 'The migration window for unresolved parent escalation deposits has closed.'
export const formatNoMigratableEscalationDeposits = (outcomeLabel: CopyTemplateValue) => `No ${outcomeLabel} escalation deposits are currently available to migrate for this wallet.`
export const migrationDepositSelectionRequired = 'Select at least one deposit to migrate.'
export const unresolvedMigrationUnavailableReason = 'Unresolved escalation migration is unavailable for this pool.'
...
export const formatLoadingChildAuctionDetails = (auctionLabel: CopyTemplateValue) => `Loading ${auctionLabel} child auction details.`
...
export const resolvedDepositMigrationDetail = 'Selected deposits leave the parent pool and reappear on the chosen child universe for later settlement.'
export const escalationMigrationEmptyEscrowDetail = 'No escrowed REP is currently visible for migratable escalation deposits on the connected wallet.'
...
export const forkWorkflowDescription = 'Load a pool to inspect fork progress, migration, and the truth auction.'
...
export const truthAuctionBids = 'Truth Auction Bids'
export const loadedLevels = 'Loaded Levels'
export const loadedBids = 'Loaded Bids'
export const coverage = 'Coverage'
export const formatLoadedBidCoverageSummary = (loadedBidCount: CopyTemplateValue, visibleBidCount: CopyTemplateValue) => `Showing ${loadedBidCount} of ${visibleBidCount} bids across loaded levels`
...
export const loadMoreOfMyBids = 'Load More Of My Bids'
...
export const loadedDepth = 'Loaded depth'
export const loadMorePriceLevels = 'Load More Price Levels'
export const loadingOrderBook = 'Loading order book…'
export const loadingPriceLevels = 'Loading price levels…'
export const marketView = 'Market View'
export const marketDepthAndBidHistory = 'Market Depth & Bid History'
