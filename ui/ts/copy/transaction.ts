...
export const priceCandidateAccepted = 'Price Candidate Accepted'
export const priceCandidateRejected = 'Price Candidate Rejected'
export const priceCandidateRejectedDetail = 'The candidate did not provide enough correction profit for the proved dispute-opportunity blocks. No price was activated.'
export const priceCandidateExpired = 'Price Candidate Expired'
export const priceCandidateExpiredDetail = 'The candidate expired before its historical-header proof was finalized. No price was activated.'
export const priceCandidateInvalidDetail = 'The settled candidate did not encode a valid positive price. No price was activated.'
