...
export const formatPoolPageSummary = (matchingPoolCount: CopyTemplateValue, loadedPoolCount: CopyTemplateValue) => `Matches: ${matchingPoolCount} of ${loadedPoolCount} pool${Number(loadedPoolCount) === 1 ? '' : commonCopy.pluralSuffix} on this page.`
