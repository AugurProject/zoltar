...
export const knownVaultRegistry = 'Known Vault Registry'
export const allPools = 'All pools'
export const hasKnownVaults = 'Has known vaults'
export const noKnownVaults = 'No known vaults'
...
export const operationBountiesDetail = 'Creators escrow REP or WETH for a pool operation. A permissionless operator supplies the Open Oracle reporting capital and earns the reward only after successful execution.'
...
export const availableOperationBounties = 'Existing bounties'
export const operationBountyLookupDetail = 'The newest 25 bounties appear automatically. Enter any bounty ID to recover an older creator or operator action.'
export const bountyId = 'Bounty ID'
export const loadBounty = 'Open Bounty'
...
export const liquidationBountyTargetMustDiffer = 'The liquidation target must differ from the bounty creator’s vault.'
...
export const targetHealthFactor = 'Target health factor'
export const targetHealthFactorHelp = 'The REP in this deposit mints price-independent capacity at this multiple of the protocol-required health level. Minimum 1.00×.'
export const requestedLiquidationDebt = 'Requested liquidation debt'
export const securityVault = 'Security Vault'
export const settingCapacityOwnership = 'Setting capacity ownership…'
...
export const vaultActionsEndedDetail = 'REP deposits are unavailable because this pool has ended. Available redemption and fee actions remain below.'
