...
export const vaultCoverageDetail = 'Ordinary coverage counts pool-held vault REP backing plus escrow attributed to this vault in the current game. Migration coverage is stricter and counts only pool-held vault REP backing; inherited carry claims remain aggregate until payout.'
