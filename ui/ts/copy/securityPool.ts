...
export const finalizePriceCandidate = 'Finalize Price Candidate'
export const finalizingPriceCandidate = 'Finalizing price candidate…'
export const candidateAwaitingProof = 'The settled report is awaiting its canonical block-header economics proof.'
