...
export const totalFreeRep = 'Total Free REP'
...
export const vaultCoverageDetail = 'Ordinary coverage counts free REP plus escrow attributed to this vault in the current game. Migration coverage is stricter and counts only free REP; inherited carry claims remain aggregate until payout.'
