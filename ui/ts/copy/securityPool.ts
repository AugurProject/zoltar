...
export const reportingOraclePriceExpiredReason = "The pool's oracle price expired. Request a new price in Open Oracle, then retry."
export const reportingOraclePriceRequiredReason = 'The pool needs an oracle price before reporting. Request one in Open Oracle.'
...
export const duplicatePoolDetail = 'Origin pool deployment is deterministic for each question and multiplier pair. Change the multiplier to create a different pool.'
