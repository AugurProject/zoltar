...
export const depositRepDescription = 'Increase this vault’s REP backing and collateralization.'
...
export const setBondAllowanceTitle = 'Set Bond Allowance'
...
export const setSecurityBondAllowanceTitle = 'Set Security Bond Allowance'
...
export const securityBondAllowanceAmountMax = 'Security Bond Allowance Amount Max'
...
export const vaultActionsEndedDetail = 'Collateral-increasing vault actions are unavailable because this pool has ended. Available redemption and fee actions remain below.'
export const vaultActionsForkMigrationDetail = 'Vault collateral actions are unavailable while this pool is in fork migration. Continue in Fork & Migration. Fee claiming remains available only when this vault has accrued fees.'
export const vaultActionsTruthAuctionDetail = 'Vault collateral actions are unavailable while this pool is in a truth auction. Continue in Fork & Migration. Fee claiming remains available only when this vault has accrued fees.'
