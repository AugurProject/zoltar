...
export const shareMigrationRisk = 'Parent-pool shares are burned and cannot be restored after migration.'
export const matchingOutcomeShares = 'Matching Yes + No + Invalid Shares'
export const sourceOutcomeShares = 'Source Outcome Shares'
export const recreatedChildShares = 'Recreated Child-Universe Shares'
...
export const retentionFeeAtExecution = 'Retention Fee at Execution'
export const retentionFeeEstimateDetail = 'Accrued pool retention fees are checkpointed before this transaction; final shares or ETH received may differ from this estimate.'
