...
export const forkAlreadyTriggeredSettlementReason = 'Escalation deposits remain locked after non-decision. The universe fork has already been triggered for this pool, so continue in Fork & Migration.'
...
export const forkRequiredSettlementReason = 'Escalation deposits remain locked after non-decision. Trigger the universe fork here if this pool should fork.'
...
export const escalationClaimNonTradeableDetail = 'Escalation claims are not tradeable. They remain attached to vault accounting, can move only as part of a proportional liquidation bundle, and become claimable after the game settles. A child truth auction can proportionally reduce both principal and reward.'
