...
export const augurPlaceholder = 'Augur PLACEHOLDER'
export const error404 = '404'
export const missingRouteDetail = 'That page is not here.'
export const hashRouteNotFound = 'Hash route not found'
export const unsupportedRouteHint = 'Use the main routes below to return to a supported page.'
export const hashNavigation = 'Hash navigation'
export const mainnetConsole = 'Mainnet console'
export const returnToDeploy = 'Return to Deploy'
export const openZoltar = 'Open Zoltar'
export const openSecurityPools = 'Open Security Pools'
