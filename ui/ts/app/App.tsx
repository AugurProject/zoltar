...
export function App() {
	...
	const securityPoolsRouteContentProps: SecurityPoolsSectionProps = {
		...
		workflow: {
			...
			onRequestPoolPrice: (managerAddress: Address, securityPoolAddress: Address, reviewedRequestEthValue: bigint) => void requestPoolPrice(managerAddress, securityPoolAddress, reviewedRequestEthValue),
