...
const ACTION_SAFETY_PROMPTS: Record<ConfirmationActionSafetyId, ActionSafetyPrompt> = {
	...
	'fork-auction.claimAuctionProceeds': {
		acknowledgeLabel: 'I understand a winning claim assigns both REP and open-interest debt to the bidder vault.',
		checklist: [
			'Claiming a winning bid adds child-pool REP and a pro-rata share of the auctioned security bond allowance to the bidder vault.',
			'That security bond allowance is the remaining open-interest debt being assigned during auction settlement.',
			'If the same settlement call includes losing bids, those rows are refunded while winning rows still add REP and bond allowance.',
		],
		confirmLabel: 'Claim Auction Proceeds',
		severity: 'danger',
		summary: 'Review the selected winning bids before assigning their REP and underwriting load to the bidder vault.',
		title: 'Review Auction Claim',
	},
	'fork-auction.submitBid': {
		acknowledgeLabel: 'I understand a winning bid can later claim both REP and open-interest debt.',
		checklist: [
			'Winning settlement does not only buy REP. It also assigns a pro-rata share of the auctioned security bond allowance to the bidder vault.',
			'That security bond allowance is the remaining open-interest debt being assigned to auction participants.',
