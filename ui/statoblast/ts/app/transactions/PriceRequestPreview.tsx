	...
	return (
		<>
			<div className='transaction-step-content'>
				<TransactionFundingSummary funding={[commonCopy.rep, commonCopy.weth].map(symbol => ({ amount: `${commonCopy.metricUnavailablePlaceholder} ${symbol}` }))} totalEth={undefined} outcome={{ returnToWallet: true, settlerRewardAttoEth: undefined, ethRefundAttoEth: undefined }} />
