...
export const noAvailableQuestions = 'No eligible binary questions are available.'
...
export const availableQuestionsLoadError = 'Available questions could not be loaded.'
