...
export const createQuestionForPoolDetail = 'Create a binary question here, then use it directly for pool deployment without leaving this tab.'
export const createQuestionForPoolTitle = 'Create a pool question'
export const universesDescription = 'Review deployed universes and switch the app context.'
...
export const vaultCoverageDetail = 'REP-per-capacity ratios describe backing, not current health. Associated REP includes at-risk dispute stake; pool-held REP is immediately held by the pool. Current health also uses live OI, REP/ETH price, the security multiplier, and both protocol constraints.'
...
export const targetHealthFactor = 'Deposit target factor'
export const targetHealthFactorHelp = 'Applies only to this deposit and determines its incremental capacity. It is not the vault’s current health. Minimum 1.00×.'
export const associatedRepPerCapacity = 'Associated REP per capacity'
export const poolHeldRepPerCapacity = 'Pool-held REP per capacity'
export const currentVaultHealth = 'Current vault health'
