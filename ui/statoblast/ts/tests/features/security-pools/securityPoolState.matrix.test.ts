...
describe('security pool action matrix data', () => {
	...
	test('lists the exact reporting, fork, and overlay allowlists', () => {
		...
		expectActionSet(ENABLED_ACTIONS_BY_FORK_STAGE.auction, ['submitBid', 'finalizeTruthAuction', 'refundLosingBids', 'withdrawAuctionRefund'])
		expectActionSet(ENABLED_ACTIONS_BY_FORK_STAGE.settlement, ['claimAuctionProceeds', 'withdrawAuctionRefund', 'settleForkedEscalation'])
