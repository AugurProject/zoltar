...
export const formatQuestionTimingHelpText = (timeZoneLabel: string) => `Your time (${timeZoneLabel}). Blank start means immediately.`
...
export const categoricalQuestionExample = 'e.g. Which team wins the 2026 World Cup?'
export const scalarQuestionDescription = 'A number inside a range, with a unit and increment.'
export const scalarQuestionExample = 'e.g. What will the ETH price be on 31 Dec, in USD?'
export const draftPreviewLabel = 'Question preview'
