...
export const overviewDescription = 'Your universe, your REP, and what to do next.'
...
export const goToGenesisTitle = 'Open Genesis'
export const goToGenesisDetail = 'This universe does not exist. Genesis is always available.'
...
export const universeNotFoundDetail = 'No universe exists with this ID. Genesis is always available.'
