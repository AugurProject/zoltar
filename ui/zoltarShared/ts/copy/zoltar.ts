...
export const reviewRepBurned = 'REP burned from wallet'
export const reviewRepPermanentlyLost = 'Permanently lost'
export const reviewMigrationCredit = 'Migration credit'
export const reviewChildRepMinted = 'Minted in each selected universe'
export const reviewForkIrreversible = 'Forking is irreversible. The REP above leaves your wallet now, and the permanent burn is never recoverable.'
export const reviewForkUniverseWide = 'This forks the universe for every REP holder, and it can never fork again.'
export const reviewMigrationBurnIrreversible = 'Burned wallet REP cannot be returned. It can only be used as child-universe REP.'
