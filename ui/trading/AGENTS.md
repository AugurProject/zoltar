...
The root and `ui/AGENTS.md` instructions apply. This package owns the Trading browser application and its tests; contracts, SDK code, deployment tooling, and their tests remain under `trading/`.
