...
export const marketRouteDescription = 'Open a market by SecurityPool address or pick one from the list.'
export const liquidityRouteDescription = 'Open a market by SecurityPool address to initialize, add, or remove liquidity.'
export const createMarketRouteDescription = 'Open a SecurityPool without a trading market to deploy its pair and seed liquidity.'
export const portfolioRouteDescription = 'Outcome, INVALID, and LP balances for every SecurityPool in the selected universe.'
export const securityPoolRouteDescription = 'Identity, lifecycle, and capacity of the SecurityPool that backs this market.'
