...
import type { Inner, mutableInnerOfKind, nodeOfKind, NodeSchema, Prerequisite } from "../kinds.ts";
...
type intersectionChildRootValueOf<k extends Intersection.FlattenedChildKind> = k extends OpenNodeKind ? listable<NodeSchema<k> | Inner<k>> : NodeSchema<k> | Inner<k>;
type conditionalRootValueOfKey<k extends ConditionalIntersectionKey> = k extends Intersection.FlattenedChildKind ? intersectionChildRootValueOf<k> : ConditionalTerminalIntersectionRoot[k & ConditionalTerminalIntersectionKey];
