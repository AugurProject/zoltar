import { CastableBase, ReadonlyArray, type propwiseXor, type show } from "@ark/util";
...
import { arkKind, type TraversalPath } from "./utils.ts";
...
export declare class ArkErrors extends ReadonlyArray<ArkError> {
