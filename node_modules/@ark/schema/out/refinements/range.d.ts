...
export declare const writeNonIntegerLengthBoundMessage: (kind: LengthBoundKind, limit: number) => string;
export declare const writeNegativeLengthBoundMessage: (kind: LengthBoundKind, limit: number) => string;
