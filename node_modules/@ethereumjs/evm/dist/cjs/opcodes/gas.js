...
const EIP7928_ts_1 = require("./EIP7928.js");
...
async function getCreateTargetAddressBytes(runState, initCode, salt) {
    ...
    if (salt !== undefined) {
        return (0, util_1.generateAddress2)(caller.bytes, salt, initCode);
    }
    const account = await runState.stateManager.getAccount(caller);
    const nonce = account?.nonce ?? util_1.BIGINT_0;
    return (0, util_1.generateAddress)(caller.bytes, (0, util_1.bigIntToBytes)(nonce));
}
/**
...
exports.dynamicGasHandlers = new Map([
    ...
    [
        ...
        async function (runState, gas, common) {
            ...
            if (common.isActivatedEIP(7928)) {
                return (0, EIP7928_ts_1.create7928Gas)(runState, gas, common, { offset, length, preChargeLabel: 'CREATE pre-charges' }, getCreateTargetAddressBytes);
            }
            if (common.isActivatedEIP(2929)) {
    ...
    [
        ...
        async function (runState, gas, common) {
            ...
            return (0, EIP7928_ts_1.callFamilyGas)(runState, gas, common, {
                currentGasLimit,
                toAddress: (0, util_ts_1.createAddressFromStackBigInt)(toAddr),
                value,
                inOffset,
                inLength,
                outOffset,
    ...
    [
        ...
        async function (runState, gas, common) {
            ...
            const salt = (0, util_1.setLengthLeft)((0, util_1.bigIntToBytes)(saltBigInt), 32);
            if (common.isActivatedEIP(7928)) {
                return (0, EIP7928_ts_1.create7928Gas)(runState, gas, common, {
                    offset,
                    length,
                    salt,
                    extraPreTargetGas: common.param('keccak256WordGas') * (0, util_ts_1.divCeil)(length, util_1.BIGINT_32),
