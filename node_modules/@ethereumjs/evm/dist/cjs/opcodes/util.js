...
exports.trap = trap;
exports.readImmediateByteOrZero = readImmediateByteOrZero;
...
function readImmediateByteOrZero(runState) {
...
function describeLocation(runState) {
    const keccakFunction = runState.interpreter._evm.common.customCrypto.keccak256 ?? sha3_js_1.keccak_256;
