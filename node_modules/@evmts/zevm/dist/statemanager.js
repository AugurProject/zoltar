...
export class AccountCache extends Cache {
    ...
    _saveCachePreState(cacheKeyHex) {
        const diffMap = this._diffCache[this._checkpoints] ?? new Map();
    ...
    commit() {
        this._checkpoints -= 1;
        const diffMap = this._diffCache.pop();
        const lowerDiffMap = this._diffCache[this._checkpoints] ?? new Map();
...
export class StorageCache extends Cache {
    ...
    _saveCachePreState(addressHex, keyHex) {
        const diffMap = this._diffCache[this._checkpoints] ?? new Map();
        this._diffCache[this._checkpoints] = diffMap;
        const diffStorageMap = diffMap.get(addressHex) ?? new Map();
    ...
    commit() {
        ...
        const lowerHeightDiffMap = this._diffCache[this._checkpoints] ?? new Map();
