...
var assertAddress = (address) => {
  const bytes = address instanceof utils.EthjsAddress || typeof address === "object" && address !== null ? (
    /** @type {{ bytes?: unknown }} */
    address.bytes
  ) : void 0;
  ...
  if (bytes.length !== 20) {
    throw new errors.InvalidAddressError("Expected from to be a 20-byte address");
  }
};
var createAddress = (address) => {
  try {
    ...
    if (typeof address === "string") {
      ...
      return new Address(utils.hexToBytes(`0x${address}`));
    }
