import * as _evmts_zevm_statemanager from '@evmts/zevm/statemanager';
import { Proof, StorageCache, AccountCache } from '@evmts/zevm/statemanager';
...
import { BlockTag, Hex as Hex$1, EthjsAddress, EthjsAccount } from '@tevm/utils';
import * as viem from 'viem';
import { Hex, EIP1193RequestFn, Transport, Address } from 'viem';
import * as _tevm_common from '@tevm/common';
import { StorageDump, EvmStateManagerInterface, AccountFields } from '@tevm/common';
...
interface StateManager extends Omit<EvmStateManagerInterface, 'getAccount' | 'putAccount' | 'modifyAccountFields' | 'shallowCopy' | 'initBinaryTreeExecutionWitness'> {
    /**
     ...
     */
    getProof(address: _tevm_utils.EthjsAddress, storageSlots?: Uint8Array[]): Promise<Proof>;
}
...
declare function getProof(baseState: BaseState): (address: _tevm_utils.EthjsAddress, storageSlots?: Uint8Array[]) => Promise<_evmts_zevm_statemanager.Proof>;
