...
export interface StateManager extends Omit<EvmStateManagerInterface, 'getAccount' | 'putAccount' | 'modifyAccountFields' | 'shallowCopy' | 'initBinaryTreeExecutionWitness'> {
    /**
     ...
     */
    dumpStorageRange(address: import('@tevm/utils').EthjsAddress, startKey: bigint, limit: number): Promise<import('@tevm/common').StorageRange>;
    /**
