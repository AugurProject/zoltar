 ...
 * Parameters for constructing a {@link CodeSizeExceedsMaximumError}.
 */
export type CodeSizeExceedsMaximumErrorParameters = {
    docsBaseUrl?: string;
    docsPath?: string;
    docsSlug?: string;
    metaMessages?: string[];
    cause?: GasLimitExceededError | import("@evmts/zevm/evm-error").EVMError;
    details?: string;
    meta?: object;
};
import { GasLimitExceededError } from '../GasLimitExceededError.js';
//# sourceMappingURL=CodeSizeExceedsMaximumError.d.ts.map