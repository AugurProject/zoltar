...
import { TxData, TransactionType, JsonTx, JsonRpcTx, TypedTransaction } from '@evmts/zevm/tx';
import { Common } from '@tevm/common';
import { EthjsAddress, Hex, BytesLike, AddressLike, BigIntLike, WithdrawalData, JsonRpcWithdrawal, Withdrawal } from '@tevm/utils';
...
declare class Block {
     ...
     */
    static computeRequestsHash(requests: ClRequest[]): Uint8Array<ArrayBuffer>;
    static genRequestsTrieRoot(requests: ClRequest[], _emptyTrie?: Trie): Promise<Uint8Array<ArrayBuffer>>;
    /**
