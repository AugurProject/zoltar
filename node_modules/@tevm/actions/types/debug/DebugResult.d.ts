...
import type { CallTraceResult, FlatCallTraceResult, FourbyteTraceResult, Hex, MuxTraceResult, PrestateTraceResult, TraceResult } from '../common/index.js';
 ...
 */
export type DebugTraceTransactionResult<TTracer extends 'callTracer' | 'prestateTracer' | '4byteTracer' | 'flatCallTracer' | 'muxTracer' | undefined = 'callTracer' | 'prestateTracer' | '4byteTracer' | 'flatCallTracer' | 'muxTracer' | undefined, TDiffMode extends boolean = boolean> = TTracer extends 'callTracer' ? CallTraceResult : TTracer extends 'prestateTracer' ? PrestateTraceResult<TDiffMode> : TTracer extends '4byteTracer' ? FourbyteTraceResult : TTracer extends 'flatCallTracer' ? FlatCallTraceResult : TTracer extends 'muxTracer' ? MuxTraceResult : TraceResult;
/**
 * Result from `debug_traceCall`
 */
export type DebugTraceCallResult<TTracer extends 'callTracer' | 'prestateTracer' | '4byteTracer' | 'flatCallTracer' | 'muxTracer' | undefined = 'callTracer' | 'prestateTracer' | '4byteTracer' | 'flatCallTracer' | 'muxTracer' | undefined, TDiffMode extends boolean = boolean> = TTracer extends 'callTracer' ? CallTraceResult : TTracer extends 'prestateTracer' ? PrestateTraceResult<TDiffMode> : TTracer extends '4byteTracer' ? FourbyteTraceResult : TTracer extends 'flatCallTracer' ? FlatCallTraceResult : TTracer extends 'muxTracer' ? MuxTraceResult : TraceResult;
/**
 * Result from `debug_traceBlock`.
 *
 * Returns an array of transaction traces
 */
export type DebugTraceBlockResult<TTracer extends 'callTracer' | 'prestateTracer' | '4byteTracer' | 'flatCallTracer' | 'muxTracer' | undefined = 'callTracer' | 'prestateTracer' | '4byteTracer' | 'flatCallTracer' | 'muxTracer' | undefined, TDiffMode extends boolean = boolean> = Array<{
    /**
     * Transaction hash
     */
    txHash: Hex;
 ...
 */
export type DebugTraceChainResult<TTracer extends 'callTracer' | 'prestateTracer' | '4byteTracer' | 'flatCallTracer' | 'muxTracer' | undefined = 'callTracer' | 'prestateTracer' | '4byteTracer' | 'flatCallTracer' | 'muxTracer' | undefined, TDiffMode extends boolean = boolean> = Array<{
    /**
     * Block number
     */
    blockNumber: number;
