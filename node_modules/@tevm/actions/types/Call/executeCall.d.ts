export function executeCall(client: import("@tevm/node").TevmNode, evmInput: import("@evmts/zevm/evm").EvmRunCallOpts, params: import("./CallParams.js").CallParams, events?: import("../common/CallEvents.js").CallEvents): Promise<(ExecuteCallResult & {
