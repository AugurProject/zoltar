 ...
 * ```
 */
export type MuxTraceResult<TTracers extends readonly MuxTracerType[] = readonly MuxTracerType[], TDiffMode extends boolean = boolean> = {
...
//# sourceMappingURL=MuxTraceResult.d.ts.map