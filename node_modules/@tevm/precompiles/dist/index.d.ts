...
import { EVMOpts, ExecResult, EvmError } from '@evmts/zevm/evm';
...
type CallReturnValue<TAbi extends Abi, TFunctionName extends string> = AbiParametersToPrimitiveTypes<ExtractAbiFunction<TAbi, TFunctionName>['outputs']> extends infer TOutputs extends readonly unknown[] ? TOutputs extends readonly [] ? undefined : TOutputs extends readonly [infer TOutput] ? TOutput : TOutputs : never;
/**
 ...
 */
declare const P256_VERIFY_GAS_COST = 6900n;
/**
...
declare const p256VerifyPrecompile: () => {
    ...
    function: (input: {
        ...
        returnValue: Uint8Array<ArrayBuffer>;
        executionGasUsed: bigint;
        exceptionError: EvmError;
    } | {
        returnValue: viem.ByteArray;
        executionGasUsed: bigint;
        exceptionError?: never;
    };
};

export { type CallResult, type ConstructorArgument, type CustomPrecompile, P256_VERIFY_ADDRESS, P256_VERIFY_GAS_COST, type TypedError, defineCall, definePrecompile, p256VerifyPrecompile };
