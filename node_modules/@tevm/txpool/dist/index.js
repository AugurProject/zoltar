import { TxPool as TxPool$1 } from '@evmts/zevm/txpool';

// src/TxPool.ts
var isFeeMarketLikeTx = (tx) => typeof tx === "object" && tx !== null && "maxFeePerGas" in tx && "maxPriorityFeePerGas" in tx && typeof tx.maxFeePerGas === "bigint" && typeof tx.maxPriorityFeePerGas === "bigint";
var isLegacyLikeTx = (tx) => typeof tx === "object" && tx !== null && "gasPrice" in tx && typeof tx.gasPrice === "bigint";
var txType = (tx) => typeof tx === "object" && tx !== null && "type" in tx ? String(tx.type) : "unknown";
var TxPool = class extends TxPool$1 {
  constructor(...args) {
    super(...args);
    const pool = this;
    pool.txGasPrice = (tx) => {
  ...
  cleanup() {
    ...
    super.cleanup();
    const liveTxs = /* @__PURE__ */ new Set();
