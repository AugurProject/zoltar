...
import type { Releases, SolcDebugSettings, SolcEvmVersion, SolcLanguage, SolcMetadataSettings, SolcModelChecker, SolcOptimizer, SolcRemapping } from '@tevm/solc';
import type { CompilationOutputOption } from './CompilationOutputOption.js';
export interface CompileBaseOptions<TLanguage extends SolcLanguage = SolcLanguage, TCompilationOutput extends CompilationOutputOption[] | undefined = CompilationOutputOption[] | undefined> {
    /**
     * EVM version
     *
...
//# sourceMappingURL=CompileBaseOptions.d.ts.map