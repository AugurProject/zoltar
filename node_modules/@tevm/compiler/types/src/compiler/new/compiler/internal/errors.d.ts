...
export class VersionResolutionError extends Error {
     ...
     */
    constructor(message: string, args?: VersionResolutionErrorParameters);
    _tag: string;
    meta: {
        code: "no_pragma" | "no_compatible_version" | "version_mismatch";
        source?: string;
        specifiers?: string[];
...
export class SolcError extends Error {
     ...
     */
    constructor(message: string, args?: SolcErrorParameters);
    _tag: string;
    meta: {
        code: "instantiation_failed" | "not_loaded" | "version_mismatch_sync";
        version?: string;
    } | undefined;
}
/**
...
export class FileValidationError extends Error {
     ...
     */
    constructor(message: string, args?: FileValidationErrorParameters);
    _tag: string;
    meta: {
        code: "invalid_array" | "empty_array" | "invalid_path" | "no_extension" | "unsupported_extension" | "mixed_extensions" | "extension_mismatch";
        filePaths?: string[];
        invalidPath?: string;
        extensions?: string[];
        language?: string;
...
export class FileReadError extends Error {
     ...
     */
    constructor(message: string, args?: FileReadErrorParameters);
    _tag: string;
    meta: {
        code: "read_failed" | "json_parse_failed";
        filePath?: string;
        absolutePath?: string;
    } | undefined;
}
...
export class CompilerOutputError extends Error {
     ...
     */
    constructor(message: string, args?: CompilerOutputErrorParameters);
    _tag: string;
    meta: {
        code: "compilation_errors" | "missing_source_output";
        errors?: import("@tevm/solc").SolcErrorEntry[];
    } | undefined;
}
/**
...
export class AstParseError extends Error {
     ...
     */
    constructor(message: string, args?: AstParseErrorParameters);
    _tag: string;
    meta: {
        code: "parse_failed" | "empty_ast" | "invalid_source_ast" | "invalid_instrumented_ast";
        sources?: string[];
    } | undefined;
}
/**
...
export class ShadowValidationError extends Error {
     ...
     */
    constructor(message: string, args?: ShadowValidationErrorParameters);
    _tag: string;
    meta: {
        code: "invalid_shadow_language" | "missing_inject_path" | "missing_inject_name" | "missing_contract_files" | "missing_contracts" | "invalid_inject_path" | "contract_not_found" | "ambiguous_contract_name";
        providedPath?: string | undefined;
        providedName?: string | undefined;
        sourceFilePaths?: string[];
        sourceContractNames?: string[];
...
export class NotSupportedError extends Error {
     ...
     */
    constructor(message: string, args?: NotSupportedErrorParameters);
    _tag: string;
    meta: {
        code: string;
    } | undefined;
 ...
 * Parameters for constructing a VersionResolutionError.
 */
export type VersionResolutionErrorParameters = {
    /**
    ...
    details?: string;
    /**
     * - Error metadata with specific code.
     */
    meta?: {
        code: "no_pragma" | "no_compatible_version" | "version_mismatch";
        source?: string;
 ...
 * Parameters for constructing a SolcError.
 */
export type SolcErrorParameters = {
    /**
     * - Base URL for the documentation.
     */
    docsBaseUrl?: string;
 ...
 * Parameters for constructing a FileValidationError.
 */
export type FileValidationErrorParameters = {
    /**
     * - Base URL for the documentation.
     */
    docsBaseUrl?: string;
 ...
 * Parameters for constructing a FileReadError.
 */
export type FileReadErrorParameters = {
    /**
     * - Base URL for the documentation.
     */
    docsBaseUrl?: string;
 ...
 * Parameters for constructing a CompilerOutputError.
 */
export type CompilerOutputErrorParameters = {
    /**
     * - Base URL for the documentation.
     */
    docsBaseUrl?: string;
 ...
 * Parameters for constructing an AstParseError.
 */
export type AstParseErrorParameters = {
    /**
     * - Base URL for the documentation.
     */
    docsBaseUrl?: string;
 ...
 * Parameters for constructing a ShadowValidationError.
 */
export type ShadowValidationErrorParameters = {
    /**
     * - Base URL for the documentation.
     */
    docsBaseUrl?: string;
 ...
 * Parameters for constructing a NotSupportedError.
 */
export type NotSupportedErrorParameters = {
    /**
     * - Base URL for the documentation.
     */
    docsBaseUrl?: string;
