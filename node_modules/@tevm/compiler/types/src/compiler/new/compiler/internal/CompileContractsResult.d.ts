 ...
 * }
 */
export interface CompileContractsResult<TCompilationOutput extends CompilationOutputOption[] | undefined = CompilationOutputOption[] | undefined, TSourcePaths extends string[] = string[]> extends CompileBaseResult {
    compilationResult: {
        [sourcePath in TSourcePaths[number] & string]: CompiledSource<TCompilationOutput>;
    };
}
//# sourceMappingURL=CompileContractsResult.d.ts.map