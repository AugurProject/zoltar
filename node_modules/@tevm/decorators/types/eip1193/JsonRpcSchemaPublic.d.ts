...
import type { RpcBlock as Block, RpcBlockIdentifier as BlockIdentifier, RpcBlockNumber as BlockNumber, RpcFeeHistory as FeeHistory, RpcLog as Log, RpcProof as Proof, Quantity, RpcStateOverride, RpcTransaction as Transaction, RpcTransactionReceipt as TransactionReceipt, RpcTransactionRequest as TransactionRequest, RpcUncle as Uncle } from 'viem';
...
export type JsonRpcSchemaPublic = {
    ...
    eth_call: {
        Method: 'eth_call';
        Parameters: [transaction: Partial<TransactionRequest>] | [transaction: Partial<TransactionRequest>, block: BlockNumber | BlockTag | BlockIdentifier] | [
...
//# sourceMappingURL=JsonRpcSchemaPublic.d.ts.map