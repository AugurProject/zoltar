...
declare function ethActions(): _tevm_node.Extension<EthActionsApi>;
...
declare function tevmActions(): _tevm_node.Extension<TevmActionsApi>;
...
type EIP1193Parameters<TRpcSchema extends RpcSchema | undefined = undefined> = TRpcSchema extends RpcSchema ? {
...
type JsonRpcSchemaPublic = {
    ...
    eth_getFilterChanges: {
        ...
        Parameters: [filterId: Quantity$1];
    ...
    eth_getStorageAt: {
        ...
        Parameters: [address: Address, index: Quantity$1, block: RpcBlockNumber | BlockTag | RpcBlockIdentifier];
        ReturnType: Hex;
    };
    /**
    ...
    eth_getTransactionByBlockHashAndIndex: {
        ...
        Parameters: [hash: Hash, index: Quantity$1];
    ...
    eth_getTransactionByBlockNumberAndIndex: {
        ...
        Parameters: [block: RpcBlockNumber | BlockTag, index: Quantity$1];
        ReturnType: RpcTransaction | null;
    };
    /**
...
type TestRpcSchema<TMode extends string> = [
    /**
    ...
    setMinGasPrice: {
        ...
        Parameters: [gasPrice: Quantity$1];
        ReturnType: void;
    },
    /**
    ...
    setNextBlockBaseFeePerGas: {
        ...
        Parameters: [baseFeePerGas: Quantity$1];
        ReturnType: void;
    },
    /**
    ...
    evm_setBlockGasLimit: {
        ...
        Parameters: [gasLimit: Quantity$1];
        ReturnType: void;
    },
    /**
     * @description Jump forward in time by the given amount of time, in seconds.
...
type Eip1193RequestProvider = {
    request: EIP1193RequestFn<[
        ...PublicRpcSchema,
        ...TestRpcSchema$1<'anvil' | 'ganache' | 'hardhat'>,
...
declare function requestEip1193(): _tevm_node.Extension<Eip1193RequestProvider>;
...
declare function tevmSend(): _tevm_node.Extension<TevmSendApi>;
