import type { Abi, Address, BlockNumber, BlockTag, CreateEventFilterParameters, ExtractAbiEvent, ExtractAbiEventNames, FormatAbi, GetEventArgs, Hex, ParseAbi } from '@tevm/utils';
/**
 ...
 * ```
 */
export type EventActionCreator<THumanReadableAbi extends readonly string[], TBytecode extends Hex | undefined, TDeployedBytecode extends Hex | undefined, TAddress extends Address | undefined, TAddressArgs = TAddress extends undefined ? {} : {
    address: TAddress;
}> = {
...
//# sourceMappingURL=EventActionCreator.d.ts.map