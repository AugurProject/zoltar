...
import { EvmType } from '@tevm/evm';
import { StateManager } from '@tevm/state';
import * as _tevm_utils from '@tevm/utils';
import { EthjsLog, Hex, WithdrawalData, BigIntLike, AsyncEventEmitter, EthjsAddress, EthjsAccount } from '@tevm/utils';
import * as _evmts_zevm_tx from '@evmts/zevm/tx';
import { AccessList, TypedTransaction, ImpersonatedTx } from '@evmts/zevm/tx';
import { ClRequest, Block, BlockOptions, HeaderData } from '@tevm/block';
import { Bloom } from '@evmts/zevm/receipt';
import { EvmResult } from '@evmts/zevm/evm';
 ...
 */
declare function applyDAOHardfork(evm: EvmType): Promise<void>;
...
declare function rewardAccount(evm: EvmType, address: EthjsAddress, reward: bigint): Promise<EthjsAccount>;
...
declare function validateRunTx(vm: BaseVm): (opts: RunTxOpts) => Promise<{
    block: Block;
    preserveJournal: boolean;
    tx: _evmts_zevm_tx.TypedTransaction;
    skipNonce?: boolean;
    skipBalance?: boolean;
    skipBlockGasLimitValidation?: boolean;
    skipHardForkValidation?: boolean;
...
export { type AddTransactionError as A, type BaseTxReceipt as B, calculateMinerReward as C, DAOConfig as D, type EIP4844BlobTxReceipt as E, calculateOmmerReward as F, deepCopy as G, execHardfork as H, genTxTrie as I, generateTxReceipt as J, KECCAK256_NULL as K, parentBeaconBlockRootAddress as L, rewardAccount as M, runBlock as N, runTx as O, type PostByzantiumTxReceipt as P, txLogsBloom as Q, type RunBlock as R, type SealBlockOpts as S, type TxReceipt as T, validateRunTx as U, type VMEvents as V, warmAddresses2929 as W, type AfterBlockEvent as a, type AfterTxEvent as b, type ApplyBlockResult as c, type BaseVm as d, BlockBuilder as e, type BlockStatus as f, type BuildBlock as g, type BuildBlockOpts as h, BuildStatus as i, type BuilderOpts as j, type DeepCopy as k, type DeepCopyError as l, type PreByzantiumTxReceipt as m, type RunBlockOpts as n, type RunBlockResult as o, type RunTx as p, type RunTxOpts as q, type RunTxResult as r, accumulateParentBeaconBlockRoot as s, accumulateParentBlockHash as t, applyBlock as u, applyDAOHardfork as v, applyTransactions as w, assignBlockRewards as x, assignWithdrawals as y, buildBlock as z };
