...
import type { RunTxResult, TxReceipt } from '../utils/index.js';
/**
 ...
 */
export declare const generateTxReceipt: (vm: BaseVm) => (tx: TypedTransaction, txResult: RunTxResult, cumulativeGasUsed: bigint, blobGasUsed?: bigint, blobGasPrice?: bigint) => Promise<TxReceipt>;
//# sourceMappingURL=generateTxResult.d.ts.map