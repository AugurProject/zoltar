...
import { loadWasmModule } from './loader.mjs';
...
export const loadKZG = async (precompute = 0, trustedSetup = mainnetTrustedSetup) => {
    ...
    const loadTrustedSetupWasm = module.cwrap('load_trusted_setup_wasm', 'number', ['array', 'array', 'array', 'number']);
    ...
    const computeCellsAndKZGProofsWasm = module.cwrap('compute_cells_and_kzg_proofs_wasm', 'string', ['array']);
    const recoverCellsFromKZGProofsWasm = module.cwrap('recover_cells_and_kzg_proofs_wasm', 'string', ['array', 'array', 'number']);
    const verifyCellKZGProofWasm = module.cwrap('verify_cell_kzg_proof_wasm', 'string', ['array', 'array', 'array']);
    const verifyCellKZGProofBatchWasm = module.cwrap('verify_cell_kzg_proof_batch_wasm', 'string', ['array', 'array', 'array', 'array', 'number']);
    /**
     *
     ...
     */
    const loadTrustedSetup = (precompute = 0, trustedSetup = mainnetTrustedSetup) => {
    ...
    const computeCellsAndKZGProofs = (blob) => {
     ...
     * @returns
     */
    const recoverCellsFromKZGProofs = (cellIndices, partial_cells, numCells) => {
    ...
    const verifyCellKZGProof = (commitment, cells, proofs) => {
    ...
    const verifyCellKZGProofBatch = (commitments, cellIndices, cells, proofs, numCells) => {
