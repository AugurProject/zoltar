...
exports.extractSpecifiersFromSource = exports.normalizeSpecifier = exports.getCompilerVersionsBySpecifiers = exports.getCustomPath = exports.isCustom = exports.isExact = exports.isFloating = exports.isFixed = void 0;
...
function isCustom(version) {
    return rx.custom.test(version);
}
exports.isCustom = isCustom;
function getCustomPath(version) {
    const m = version.match(rx.custom);
    (0, misc_1.assert)(m !== null, `Bad custom version {0}`, version);
    return m[1];
}
