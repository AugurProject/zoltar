...
class ContractDefinition extends ast_node_1.ASTNodeWithChildren {
    constructor(id, src, name, scope, kind, abstract, fullyImplemented, linearizedBaseContracts, usedErrors, usedEvents, documentation, children, nameLocation, baseSlotExpression, raw) {
        super(id, src, raw);
        this.name = name;
        this.scope = scope;
        this.kind = kind;
