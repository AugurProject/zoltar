...
- For UI changes, include images that show the resulting UI. Do not commit these images to the repository; upload them to GitHub and embed them in the pull request description instead.
