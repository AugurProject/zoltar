...
import { UniformPriceDualCapBatchAuction } from '../../statoblast/UniformPriceDualCapBatchAuction.sol';
import { ISecurityPool, ISecurityPoolFactory, SystemState } from '../../statoblast/interfaces/ISecurityPool.sol';
...
import { SecurityPoolForkerBase } from '../../statoblast/SecurityPoolForkerBase.sol';
...
contract SecurityPoolForkerEscrowAttackParentMock {
	...
	function configureVault(address, uint256, uint256, uint256, uint256, uint256) external pure {}
}
...
contract SecurityPoolForkerEscrowAttackChildMock {
	...
	function configureVault(address, uint256, uint256, uint256, uint256, uint256) external {
