...
library TwoWayConstantProductMath {
	...
	function quoteExactInput(uint256 reserveIn, uint256 reserveOut, uint256 amountIn, uint256 feeBps) internal pure returns (uint256 amountOut, uint256 feeAmount) {
	...
	function quoteExactOutput(uint256 reserveIn, uint256 reserveOut, uint256 amountOut, uint256 feeBps) internal pure returns (uint256 amountIn, uint256 feeAmount) {
		require(reserveIn > 0 && reserveOut > 0, 'Empty reserves');
	...
	function proportionalDeposit(uint256 yesReserve, uint256 noReserve, uint256 maxYes, uint256 maxNo) internal pure returns (uint256 yesUsed, uint256 noUsed) {
	...
	function initialLiquidityAmounts(uint256 completeSets, uint256 conditionalYesBpsValue) internal pure returns (uint256 yesAmount, uint256 noAmount) {
	...
	function _productOfSumAtMost(uint256 multiplier, uint256 first, uint256 second, uint256 rightMultiplier, uint256 rightValue) private pure returns (bool) {
