...
abstract contract SecurityPoolForkerStorage {
	...
	mapping(ISecurityPool => mapping(uint8 => OwnForkChildRepAllocation)) internal ownForkChildRepAllocationByPoolAndOutcome;
	mapping(ISecurityPool => mapping(address => ForkedEscrowState)) internal forkedEscrowStateByPoolAndVault;
