...
interface IAugur {
	...
	event InitialReportSubmitted(
		...
		string description,
		uint256 nextWindowStartTime,
		uint256 nextWindowEndTime,
		uint256 timestamp
	);
	...
	event DisputeCrowdsourcerCompleted(
		...
		uint256 nextWindowEndTime,
		bool pacingOn,
		uint256 totalRepStakedInPayout,
		uint256 totalRepStakedInMarket,
		uint256 disputeRound,
		uint256 timestamp
	);
	...
	event MarketFinalized(
		...
		address indexed question,
		uint256 timestamp,
		uint256[] winningPayoutNumerators
	);
	...
	event UniverseCreated(
		address indexed parentUniverse,
		address indexed childUniverse,
		uint256[] payoutNumerators,
		uint256 creationTimestamp
	);
	event CompleteSetsPurchased(
		address indexed universe,
		address indexed question,
	...
	event ParticipationTokensRedeemed(
		address indexed universe,
