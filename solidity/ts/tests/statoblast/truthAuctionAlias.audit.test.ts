...
import {
	...
	test_statoblast_TruthAuctionAliasAttackMocks_TruthAuctionAliasAttackFactoryMock,
	test_statoblast_TruthAuctionAliasAttackMocks_TruthAuctionAliasAttackParentMock,
	test_statoblast_TruthAuctionAliasAttackMocks_TruthAuctionAliasAttackShareTokenMock,
	...
	test('a fake lineage cannot alias or finalize a canonical truth auction', async () => {
		...
		const shareTokenDeploymentHash = await client.sendTransaction({
			data: encodeDeployData({
				abi: test_statoblast_TruthAuctionAliasAttackMocks_TruthAuctionAliasAttackShareTokenMock.abi,
				bytecode: `0x${test_statoblast_TruthAuctionAliasAttackMocks_TruthAuctionAliasAttackShareTokenMock.evm.bytecode.object}`,
				args: [],
			}),
		})
		...
		const factoryDeploymentHash = await client.sendTransaction({
			data: encodeDeployData({
				abi: test_statoblast_TruthAuctionAliasAttackMocks_TruthAuctionAliasAttackFactoryMock.abi,
				bytecode: `0x${test_statoblast_TruthAuctionAliasAttackMocks_TruthAuctionAliasAttackFactoryMock.evm.bytecode.object}`,
				args: [],
			}),
		})
		...
		const parentDeploymentHash = await client.sendTransaction({
			data: encodeDeployData({
				abi: test_statoblast_TruthAuctionAliasAttackMocks_TruthAuctionAliasAttackParentMock.abi,
				bytecode: `0x${test_statoblast_TruthAuctionAliasAttackMocks_TruthAuctionAliasAttackParentMock.evm.bytecode.object}`,
		...
		const undeployedAuctionChildHash = await client.sendTransaction({
			data: encodeDeployData({
				abi: test_statoblast_TruthAuctionAliasAttackMocks_TruthAuctionAliasAttackChildMock.abi,
				bytecode: `0x${test_statoblast_TruthAuctionAliasAttackMocks_TruthAuctionAliasAttackChildMock.evm.bytecode.object}`,
