...
import { decodeEventLog, encodeAbiParameters, encodeDeployData, encodeFunctionData, isHex, keccak256, type Address, type Hash, type Hex } from '@zoltar/shared/evm/ethereum'
import {
	computeClearing,
