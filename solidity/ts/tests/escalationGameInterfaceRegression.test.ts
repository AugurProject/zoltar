...
test('EscalationGame storage layout keeps inherited state slots stable', () => {
	...
	assert.deepStrictEqual(
		...
		[
			...
			{ label: 'claimBundlesByOwner', slot: '431', offset: 0, type: 'mapping(address => address[8])' },
			...
			{ label: 'fixedQuestionOutcome', slot: '441', offset: 20, type: 'enum BinaryOutcomes.BinaryOutcome' },
			{ label: 'nonDecisionState', slot: '441', offset: 21, type: 'enum NonDecisionState' },
			{ label: 'forkCarryBackingExportedBeforeResume', slot: '442', offset: 0, type: 'uint256' },
			{ label: 'truthAuctionRepBefore', slot: '443', offset: 0, type: 'uint256' },
			{ label: 'truthAuctionRepRemaining', slot: '444', offset: 0, type: 'uint256' },
			{ label: 'payoutClaimBundles', slot: '445', offset: 0, type: 'mapping(address => struct EscalationClaimBundle)' },
			{ label: 'payoutClaimBundlesByOwner', slot: '446', offset: 0, type: 'mapping(address => address[8])' },
		],
	)
