...
test('EscalationGame storage layout keeps inherited state slots stable', () => {
	...
	assert.deepStrictEqual(
		...
		[
			...
			{ label: 'claimBundlesByOwner', slot: '431', offset: 0, type: 'mapping(address => address[64])' },
			{ label: 'totalEscrowedRep', slot: '432', offset: 0, type: 'uint256' },
			{ label: 'unresolvedRepByVault', slot: '433', offset: 0, type: 'mapping(address => uint256)' },
			{ label: 'totalLocalUnresolvedRep', slot: '434', offset: 0, type: 'uint256' },
			{ label: 'localUnresolvedPrincipalByVaultAndOutcome', slot: '435', offset: 0, type: 'mapping(address => uint256[3])' },
			{ label: 'localUnresolvedTotalsExportedByVault', slot: '436', offset: 0, type: 'mapping(address => bool)' },
			{
			...
			{ label: 'forkCarrySnapshotRequiresForkedEscrow', slot: '438', offset: 0, type: 'bool' },
			{ label: 'winnerHaircutPaidByFork', slot: '438', offset: 1, type: 'bool' },
			{ label: 'forkCarryInitialBacking', slot: '439', offset: 0, type: 'uint256' },
			{ label: 'forkCarryEscrowedRep', slot: '440', offset: 0, type: 'uint256' },
			{ label: 'forkCarrySourceGame', slot: '441', offset: 0, type: 'address' },
			{ label: 'forkCarryRootClaimSourceGame', slot: '442', offset: 0, type: 'address' },
			{ label: 'cumulativeClaimRetention', slot: '443', offset: 0, type: 'uint256' },
			{ label: 'cumulativeClaimRetentionExponent', slot: '444', offset: 0, type: 'uint256' },
			{ label: 'fixedQuestionOutcome', slot: '445', offset: 0, type: 'enum BinaryOutcomes.BinaryOutcome' },
			{ label: 'nonDecisionState', slot: '445', offset: 1, type: 'enum NonDecisionState' },
			{ label: 'forkCarryBackingExportedBeforeResume', slot: '446', offset: 0, type: 'uint256' },
			{ label: 'truthAuctionRepBefore', slot: '447', offset: 0, type: 'uint256' },
			{ label: 'truthAuctionRepRemaining', slot: '448', offset: 0, type: 'uint256' },
			{ label: 'payoutClaimBundles', slot: '449', offset: 0, type: 'mapping(address => struct EscalationClaimBundle)' },
			{ label: 'payoutClaimBundlesByOwner', slot: '450', offset: 0, type: 'mapping(address => address[64])' },
			{ label: 'payoutClaimBundleKeys', slot: '451', offset: 0, type: 'address[]' },
			{ label: 'forkCarryPayoutClaimImportCursor', slot: '452', offset: 0, type: 'uint256' },
		],
	)
	...
	assert.deepStrictEqual(storageMemberSummary(typeTable, 'struct EscalationClaimBundle'), [
		{ label: 'escrowedRep', slot: '0', offset: 0, type: 'uint256' },
		{ label: 'totalShares', slot: '1', offset: 0, type: 'uint256' },
		{ label: 'owners', slot: '2', offset: 0, type: 'address[8]' },
		{ label: 'ownerShares', slot: '10', offset: 0, type: 'uint256[8]' },
	])
})
