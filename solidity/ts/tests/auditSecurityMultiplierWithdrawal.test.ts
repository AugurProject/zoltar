...
import { manipulatePriceOracleAndPerformOperation, manipulatePriceOracle, setCoverageOfferFixture } from '../testSupport/simulator/utils/contracts/statoblastTestUtils'
...
describe('Audit PoC: security multiplier withdrawal bypass', () => {
	...
	test('a multiplier-safe vault cannot withdraw below multiplier-adjusted coverage', async () => {
		...
		await setCoverageOfferFixture(client, mockWindow, coordinator, client.account.address, capacityOwnershipAttoRep, reportedRepEthPrice)
