...
export const EthGetStorageAtResponse = funtypes.Union(EthereumBytes32, funtypes.String.withParser({ parse: x => (x === '0x' ? { success: true, value: null } : { success: false, message: 'eth_getStorageAt didn\'t return 32 bytes of data nor 0x.' }) }))

export type EthGetLogsRequest = funtypes.Static<typeof EthGetLogsRequest>
export const EthGetLogsRequest = funtypes.Intersect(
	funtypes.Union(funtypes.ReadonlyObject({ blockHash: EthereumBytes32 }).asReadonly(), funtypes.Partial({ fromBlock: EthereumBlockTag, toBlock: EthereumBlockTag }).asReadonly()),
	funtypes
		.Partial({
...
export const PartialEthereumTransaction = funtypes
	.ReadonlyPartial({
...
export const EthTransactionReceiptResponse = funtypes.Union(
	...
	funtypes.Intersect(
		...
		funtypes.Intersect(
			funtypes.Union(
				funtypes.ReadonlyObject({
					type: funtypes.Union(funtypes.Union(funtypes.Literal('0x0').withParser(LiteralConverterParserFactory('0x0', 'legacy' as const)), funtypes.Literal(undefined).withParser(LiteralConverterParserFactory(undefined, 'legacy' as const))), funtypes.Literal('0x0').withParser(LiteralConverterParserFactory('0x0', 'legacy' as const)), funtypes.Literal('0x1').withParser(LiteralConverterParserFactory('0x1', '2930' as const)), funtypes.Literal('0x2').withParser(LiteralConverterParserFactory('0x2', '1559' as const))),
				}),
				funtypes.ReadonlyObject({
			...
			funtypes.ReadonlyObject({
				...
				status: funtypes.Union(funtypes.Literal('0x0').withParser(LiteralConverterParserFactory('0x0', 'failure' as const)), funtypes.Literal('0x1').withParser(LiteralConverterParserFactory('0x1', 'success' as const))),
			}),
		),
	),
)
...
const JsonRpcSuccessResponse = funtypes
	.ReadonlyObject({
...
export const JsonRpcErrorResponse = funtypes
	.ReadonlyObject({
		jsonrpc: funtypes.Literal('2.0'),
		id: funtypes.Union(funtypes.String, funtypes.Number),
		error: funtypes
...
export const EthCallParams = funtypes
	.ReadonlyObject({
		method: funtypes.Literal('eth_call'),
		params: funtypes.ReadonlyTuple(PartialEthereumTransaction, EthereumBlockTag),
	})
	.asReadonly()

export type EthGetLogsParams = funtypes.Static<typeof EthGetLogsParams>
export const EthGetLogsParams = funtypes
	.ReadonlyObject({
...
export const SwitchEthereumChainParams = funtypes
	.ReadonlyObject({
...
const RequestPermissions = funtypes
	.ReadonlyObject({
...
export const GetTransactionCount = funtypes
	.ReadonlyObject({
...
export const GetSimulationStack = funtypes
	.ReadonlyObject({
...
export const FeeHistory = funtypes.ReadonlyObject({
	...
	params: funtypes.Union(funtypes.ReadonlyTuple(EthereumQuantityBetween1And1024, EthereumBlockTag), funtypes.ReadonlyTuple(EthereumQuantityBetween1And1024, EthereumBlockTag, funtypes.ReadonlyArray(funtypes.Number))),
})
