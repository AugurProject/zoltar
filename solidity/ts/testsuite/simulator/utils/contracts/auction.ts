...
export const submitBid = async (client: WriteClient, auctionAddress: `0x${ string }`, tick: bigint, ethAmount: bigint) => await client.writeContract({
	abi: peripherals_DualCapBatchAuction_DualCapBatchAuction.abi,
...
export const finalize = async (client: WriteClient, auctionAddress: `0x${ string }`) => await client.writeContract({
	abi: peripherals_DualCapBatchAuction_DualCapBatchAuction.abi,
...
export const refundLosingBids = async (client: WriteClient, auctionAddress: `0x${ string }`, tickIndex: readonly { tick: bigint; bidIndex: bigint }[]) => await client.writeContract({
	abi: peripherals_DualCapBatchAuction_DualCapBatchAuction.abi,
...
export const withdrawBids = async (client: WriteClient, auctionAddress: `0x${ string }`, withdrawFor: `0x${ string }`, tickIndex: readonly { tick: bigint; bidIndex: bigint }[]) => await client.writeContract({
	abi: peripherals_DualCapBatchAuction_DualCapBatchAuction.abi,
...
export const isFinalized = async (client: ReadClient, auctionAddress: `0x${ string }`) => await client.readContract({
	abi: peripherals_DualCapBatchAuction_DualCapBatchAuction.abi,
...
export const deployDualCapBatchAuction = async (client: WriteClient, owner: `0x${ string }`) => await client.writeContract({
...
export const getClearingTick = async (client: ReadClient, auctionAddress: `0x${ string }`) => await client.readContract({
	abi: peripherals_DualCapBatchAuction_DualCapBatchAuction.abi,
...
export const getMinBidSize = async (client: ReadClient, auctionAddress: `0x${ string }`) => await client.readContract({
	abi: peripherals_DualCapBatchAuction_DualCapBatchAuction.abi,
...
export const getEthRaiseCap = async (client: ReadClient, auctionAddress: `0x${ string }`) => await client.readContract({
	abi: peripherals_DualCapBatchAuction_DualCapBatchAuction.abi,
...
export const getEthRaised = async (client: ReadClient, auctionAddress: `0x${ string }`) => await client.readContract({
	abi: peripherals_DualCapBatchAuction_DualCapBatchAuction.abi,
