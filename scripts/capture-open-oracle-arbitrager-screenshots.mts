...
import { getAddress, keccak256, toHex } from '@zoltar/shared/ethereum'
import { startDashboardServer } from '../open-oracle-arbitrager/dashboard-server.js'
import { operatorSnapshot, type OperatorSnapshot, type OperatorState } from '../open-oracle-arbitrager/operator-state.js'
import type { PositionRecord } from '../open-oracle-arbitrager/position-store.js'
...
const snapshot = {
	...
	submission: { minimumRelaySuccesses: 1, mode: 'private' as const, relayUrls: ['https://relay.flashbots.net/'] },
...
try {
	...
	const outputDirectory = join(import.meta.dir, '..', 'open-oracle-arbitrager', 'documentation-assets')
