...
describe('test impact recommendations', () => {
	...
	test('maps CI workflow changes to workflow contract tests', () => {
		expect(commandsFor(['.github/workflows/browser-workflow.yml', '.github/workflows/coverage.yml', '.github/workflows/test-domains.yml', '.github/workflows/test-stability.yml', 'workflow/coverage.yml'])).toEqual(['bun test scripts/ui-split-workflows.test.ts'])
	})
