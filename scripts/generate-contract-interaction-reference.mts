...
const outputPath = 'docs/reference/contracts.md'
...
assert.match(markdown, /^<!-- Generated by scripts\/generate-contract-interaction-reference\.mts\. Do not edit directly\. -->/, 'contract reference must identify its canonical generator')
...
The main state-changing protocol calls map to caller authority, lifecycle prerequisites, effects, and observable events below. The conceptual flow begins in [Start Here](../documentation.html), while the [Operator Reference](./operator-guardrails.html) covers edge cases and the application build consumes the complete generated ABI.
