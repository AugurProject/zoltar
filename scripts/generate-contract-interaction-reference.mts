...
const contractReferences: ContractReference[] = [
	...
	},
	{
		...
		securityBoundary:
			'Price-sensitive withdrawal, allowance, and liquidation calls depend on [A14 timely inclusion](./security-model.html#assumption-a14), [A18 external token behavior](./security-model.html#assumption-a18), [A20 observable correctable price](./security-model.html#assumption-a20), and [A21 lifecycle executors](./security-model.html#assumption-a21). User-initiated pool calls additionally depend on [A31 account authority](./security-model.html#assumption-a31).',
		readDeclarations: [
	...
	},
	{
		...
		securityBoundary:
			'Report and staged-operation liveness depends on [A14 timely inclusion](./security-model.html#assumption-a14), [A16 available arbitrager](./security-model.html#assumption-a16), [A17 independent corrector](./security-model.html#assumption-a17), [A20 observable correctable price](./security-model.html#assumption-a20), and [A21 lifecycle executors](./security-model.html#assumption-a21). An official-client proposal made when `lastPrice` is zero and the client must request an offchain market quote additionally depends on [A30 representative client quotes](./security-model.html#assumption-a30); proposals copied from a nonzero cached price do not.',
		readDeclarations: [
			{ name: 'isPriceValid' },
...
The external boundaries most directly affecting these interactions are [A07 practical migration](./security-model.html#assumption-a07), [A14 timely inclusion](./security-model.html#assumption-a14), [A18 external token behavior](./security-model.html#assumption-a18), [A19 verified deployments](./security-model.html#assumption-a19), [A21 lifecycle executors](./security-model.html#assumption-a21), [A22 chain data and proof availability](./security-model.html#assumption-a22), [A23 Ethereum execution](./security-model.html#assumption-a23), [A24 cryptographic security](./security-model.html#assumption-a24), [A28 asset-recipient compatibility](./security-model.html#assumption-a28), [A29 client, RPC, and wallet integrity](./security-model.html#assumption-a29), and [A31 account authority](./security-model.html#assumption-a31).
