...
test('check-changed keeps UI apps and the review contract while filtering unsupported config paths', () => {
	const biomeChangedFiles = getBiomeChangedFiles(['.codex/agents/reviewer.toml', '.codex/review-contract.md', 'bunfig.toml', 'solidity/contracts/statoblast/WETH9.sol', 'ui/zoltar/ts/app/App.tsx', 'ui/trading/ts/app/App.tsx', 'ui/trading/css/app.css', 'scripts/check-changed.mts'])
