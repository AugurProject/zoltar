...
for (const appId of UI_APP_IDS) {
	...
	test(`${appId}/index.html import maps are valid JSON with required mappings`, () => {
		...
		expect(imports['@zoltar/shared/logScan']).toBe('../shared/js/evm/logScan.js')
		expect(imports['@zoltar/shared/scalarOutcome']).toBe('../shared/js/statoblast/scalarOutcome.js')
