...
export const sourceSizeAllowances = new Map<string, SourceSizeAllowance>([
	...allowances('Chaos: extract dashboard features, operation handlers, and persistence responsibilities into focused modules.', [
		...
		['bots/chaos/src/execution/transaction-executor.ts', 1268],
		['bots/chaos/src/runtime/operator.ts', 932],
	...
	...allowances('Owning bot package: extract dashboard controllers, runtime orchestration, and journal persistence into focused modules.', [
		['bots/open-oracle-arbitrager/src/dashboard/dashboard.ts', 1545],
		['bots/open-oracle-arbitrager/src/runtime/operator.ts', 1063],
		['bots/open-oracle-arbitrager/src/state/operator-state.ts', 976],
		...
		['bots/liquidator/src/dashboard/dashboard.ts', 1069],
	...
	...allowances('Owning UI library: separate workflow state and actions from rendering, and extract simulation scenario handlers.', [
		['ui/statoblastShared/ts/features/security-pools/components/SecurityPoolWorkflowSection.tsx', 951],
		...
		['ui/statoblastShared/ts/features/security-pools/components/SecurityVaultSection.tsx', 719],
	...
	...allowances('Bot QA and documentation capture scripts grew with every dashboard surface they exercise.', [
		['bots/open-oracle-arbitrager/scripts/capture-docs-screenshots.mts', 1905],
