...
export const sourceSizeAllowances = new Map<string, SourceSizeAllowance>([
	...
	...allowances('Existing UI workflow debt is owned by the functional or visual lanes.', [
		...
		['ui/statoblastDomain/ts/features/truth-auctions/components/ForkAuctionSection.tsx', 1070],
		...
		['ui/statoblastDomain/ts/protocol/securityPools.ts', 837],
		...
		['ui/zoltarDomain/ts/features/reporting/components/ReportingSection.tsx', 750],
		['ui/statoblastDomain/ts/features/security-pools/components/LiquidationModal.tsx', 701],
		['ui/coreShared/ts/app/hooks/useOnchainState.ts', 690],
		['ui/zoltarDomain/ts/features/open-oracle/lib/openOracle.ts', 685],
