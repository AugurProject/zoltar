...
const dataOutput = `// Generated by tooling/docs/build-docs-index.mts. Do not edit directly.\nwindow.statoblastDocs = ${JSON.stringify(manifest)}\n`
const searchDataOutput = `// Generated by tooling/docs/build-docs-index.mts. Loaded on demand; do not edit directly.\nwindow.statoblastDocsSearch = ${JSON.stringify(searchIndex)}\n`
if (checkOnly) {
