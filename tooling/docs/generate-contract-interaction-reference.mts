...
assert.match(content, /^<!-- Generated by tooling\/docs\/generate-contract-interaction-reference\.mts\. Do not edit directly\. -->/, 'contract reference must identify its canonical generator')
...
${rows}
	...
	return `<!-- Generated by tooling/docs/generate-contract-interaction-reference.mts. Do not edit directly. -->
	<header>
