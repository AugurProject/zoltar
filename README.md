...
- [Security model](https://augurproject.github.io/zoltar/docs/security-model.html) — normative participant, market, asset, deployment, client, data, Ethereum, account-authority, and cryptographic assumptions A01–A30
...
- Production quote-dependent flows rely on live RPC data and available Uniswap liquidity under [A26 client and RPC integrity](https://augurproject.github.io/zoltar/docs/security-model.html#assumption-a26) and [A21 representative client quotes](https://augurproject.github.io/zoltar/docs/security-model.html#assumption-a21). If a quote is stale, unavailable, or unsupported, affected actions should remain blocked or degraded rather than falling back to simulated prices.
