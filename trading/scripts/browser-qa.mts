...
const scenarios = [
	...
	},
	{
		...
		height: 844,
		path: '/?demo=1&scenario=baseline#/portfolio',
		assertExpression: `!document.body.textContent?.includes('Balance scope') && [...document.querySelectorAll('.table-row a')].every(control => control.getBoundingClientRect().height >= 44)`,
		scrollY: 360,
	},
	{
