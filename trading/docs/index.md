...
- **Reference:** [contracts](reference/contracts.md), [router](reference/router.md), [events](reference/events.md), [SDK](reference/sdk.md), [configuration](reference/configuration.md), [deployment manifests](reference/deployment-manifests.md), [trading invariants](reference/invariants.md), and [units and rounding](reference/units-and-rounding.md).
